...
public class b extends d {
    ...
    private void c(Intent intent) {
        if (this.c != null) {
            ...
            if (stringExtra == null) {
                stringExtra = intent.getStringExtra(ab.an);
            }
            if (stringExtra == null) {
                ...
                String stringExtra2 = intent.getStringExtra(a.X);
                if (stringExtra2 != null) {
                    stringExtra = intent.getStringExtra(ab.an) + ": " + stringExtra2;
                }
    ...
    private void d(Intent intent) {
        if (intent != null) {
            ...
            Throwable th = new Throwable(stringExtra + " (" + intent.getStringExtra(ab.an) + ")");
            if (this.c != null) {
                this.c.onFailed(th);
            }
        } else if (this.c != null) {
