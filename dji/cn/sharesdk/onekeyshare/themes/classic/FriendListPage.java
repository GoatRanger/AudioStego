...
public abstract class FriendListPage extends OnekeySharePage implements OnClickListener, OnItemClickListener {
    ...
    public void onCreate() {
        ...
        ViewGroup.LayoutParams layoutParams = new LayoutParams(-1, (int) (ratio < 1.0f ? 1.0f : ratio));
    ...
    public void onClick(View view) {
        ...
        hashMap.put(DJIPhotoPreveiwActivity.D, arrayList);
    ...
    private void updateConfirmView() {
        ...
        if (this.checkNum == 0) {
            ...
            this.tvConfirm.setText(obj + "(" + this.checkNum + ")");
        }
    }
}
