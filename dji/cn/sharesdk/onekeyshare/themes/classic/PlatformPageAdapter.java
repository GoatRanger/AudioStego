...
public abstract class PlatformPageAdapter extends ViewPagerAdapter implements OnClickListener {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        refreshPanel((LinearLayout[]) R.forceCast(((LinearLayout) R.forceCast(view)).getTag()), this.cells[i]);
        return view;
    }
    ...
    private void refreshPanel(LinearLayout[] linearLayoutArr, Object[] objArr) {
        int bitmapRes = R.getBitmapRes(this.page.getContext(), "ssdk_oks_classic_platform_cell_back");
        int bitmapRes2 = R.getBitmapRes(this.page.getContext(), "ssdk_oks_classic_platfrom_cell_back_nor");
        for (int i = 0; i < objArr.length; i++) {
            ...
            if (objArr[i] == null) {
                ...
                if (objArr[i] instanceof CustomerLogo) {
                    CustomerLogo customerLogo = (CustomerLogo) R.forceCast(objArr[i]);
    ...
    public void onClick(View view) {
        ...
        if (currentTimeMillis - this.lastClickTime >= 1000) {
            ...
            if (view.getTag() instanceof CustomerLogo) {
                this.page.performCustomLogoClick(view, (CustomerLogo) R.forceCast(view.getTag()));
                return;
            }
            this.page.showEditPage((Platform) R.forceCast(view.getTag()));
        }
    }
}
