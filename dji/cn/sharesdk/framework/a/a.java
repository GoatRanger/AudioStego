...
public class a extends NetworkHelper {
    ...
    public String b(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut, String str2, int i) throws Throwable {
        a(str2, i);
