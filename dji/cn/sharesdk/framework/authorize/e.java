...
public class e extends a implements Callback, OnResizeListener {
    ...
    private static class a implements Interpolator {
        ...
        public float getInterpolation(float f) {
            int i = 100;
            int i2 = (int) (DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity * f);
            if (i2 < 0) {
                i2 = 0;
            }
            if (i2 <= 100) {
    ...
    public void onCreate() {
        ...
        if (!(this.c == null || this.c.isPopUpAnimationDisable())) {
            Animation scaleAnimation = new ScaleAnimation(0.0f, 1.0f, 0.0f, 1.0f, 1, dji.pilot.visual.a.d.c, 1, dji.pilot.visual.a.d.c);
