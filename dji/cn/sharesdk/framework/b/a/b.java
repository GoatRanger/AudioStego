...
public class b {
    ...
    public Cursor a(String str, String[] strArr, String str2, String[] strArr2, String str3) {
        ...
        d.a().d("Query table: %s", new Object[]{str});
        try {
            return writableDatabase.query(str, strArr, str2, strArr2, null, null, str3);
        } catch (Throwable e) {
            d.a().w(e, "when query database occur error table:%s,", new Object[]{str});
            return null;
        }
    }
    ...
    public long a(String str, ContentValues contentValues) {
        ...
        try {
            ...
            d.a().w(e, "when insert database occur error table:%s,", new Object[]{str});
        }
        return j;
    }
    ...
    public int a(String str, String str2, String[] strArr) {
        ...
        try {
            ...
            try {
                d.a().d("Deleted %d rows from table: %s", new Object[]{Integer.valueOf(delete), str});
            } catch (Exception e2) {
                e = e2;
                d.a().w(e, "when delete database occur error table:%s,", new Object[]{str});
                return delete;
            }
        } catch (Throwable e3) {
            e = e3;
