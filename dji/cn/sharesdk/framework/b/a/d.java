    ...
    public static synchronized long a(Context context, ArrayList<String> arrayList) {
        ...
        synchronized (d.class) {
            if (arrayList == null) {
                ...
                cn.sharesdk.framework.utils.d.a().i("delete COUNT == %s", new Object[]{Integer.valueOf(b.a(context).a("message", "_id in ( " + stringBuilder.toString().substring(0, stringBuilder.length() - 1) + " )", null))});
