...
public class a {
    ...
    public void b() {
        try {
            ...
            if (!"none".equals(networkType) && !TextUtils.isEmpty(networkType) && this.d.g()) {
                ...
                HashMap hashMap;
                if (c.containsKey(c.ad)) {
                    this.d.a("service_time", Long.valueOf(System.currentTimeMillis() - R.parseLong(String.valueOf(c.get(c.ad)))));
                }
                if (c.containsKey("switchs")) {
                    hashMap = (HashMap) c.get("switchs");
                    if (hashMap != null) {
                        String valueOf = String.valueOf(hashMap.get("device"));
                        String valueOf2 = String.valueOf(hashMap.get(WBConstants.ACTION_LOG_TYPE_SHARE));
                    ...
                    if (hashMap != null) {
                        ...
                        if (hashMap.containsKey("assigns")) {
                            ...
                            for (String str : hashMap.keySet()) {
                                ...
                                Object valueOf7 = String.valueOf(hashMap3.get(com.alipay.sdk.b.c.f));
    ...
    private String c(String str) throws Throwable {
        ...
        if (b != null && b.size() > 0 && b.containsKey("status") && R.parseInt(String.valueOf(b.get("status"))) == 200 && b.containsKey("url")) {
    ...
    private String a(String str, String str2, int i, String str3) throws Throwable {
        ...
        if (a == null || a.size() <= 0 || !a.containsKey("data")) {
            return str;
        }
        arrayList = (ArrayList) a.get("data");
        ...
        d.a().i("> SERVER_SHORT_LINK_URL content after replace link ===  %s", new Object[]{stringBuilder.toString()});
