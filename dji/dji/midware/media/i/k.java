...
public class k implements g {
    ...
    public void a(int i, final int i2) {
        ...
        DataCameraSingleChoice.getInstance().setKey(i).start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                DJILogHelper.getInstance().LOGD(k.a, "restart success " + i2, false, true);
                if (i2 > 0) {
                    try {
                        Thread.sleep(1500);
                    ...
                    DJILogHelper.getInstance().LOGD(k.a, "restart seek to " + i2, false, true);
                    this.b.a((long) i2);
                }
            }

            public void onFailure(dji.midware.data.config.P3.a aVar) {
                DJILogHelper.getInstance().LOGD(k.a, "restart fail", false, true);
            }
        });
    }
    ...
    public void c() {
        if (this.b == MODE.SinglePlay) {
            ...
            this.j.setControlType(ControlType.Start).start(new d(this) {
                ...
                public void onSuccess(Object obj) {
                    DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Start Success", false, true);
                    this.a.e = true;
                    this.a.f = false;
                }

                public void onFailure(dji.midware.data.config.P3.a aVar) {
                    DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Start Fail", false, true);
                }
            });
        }
    }
    ...
    public void d() {
        if (this.b == MODE.SingleOver) {
            ...
            this.j.setControlType(ControlType.Stop).start(new d(this) {
                ...
                public void onSuccess(Object obj) {
                    DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Stop Success", false, true);
                    this.a.e = false;
                }

                public void onFailure(dji.midware.data.config.P3.a aVar) {
                    DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Stop Fail", false, true);
                }
            });
        }
    }
    ...
    public void e() {
        if (this.b == MODE.SinglePause || this.b == MODE.SingleOver) {
            ...
            this.j.setControlType(ControlType.Pause).start(new d(this) {
                ...
                public void onSuccess(Object obj) {
                    DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Pause Success", false, true);
                    this.a.e = false;
                    this.a.f = true;
                }

                public void onFailure(dji.midware.data.config.P3.a aVar) {
                    DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Pause Fail", false, true);
                }
            });
        }
    }
    ...
    public void a(final long j) {
        this.j.setControlType(ControlType.StepTo).setProgress((int) j).start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Seek To " + j + "ms Success", false, true);
            }

            public void onFailure(dji.midware.data.config.P3.a aVar) {
                DJILogHelper.getInstance().LOGD(k.a, "MediaPlayer Seek To " + j + "ms Fail", false, true);
            }
        });
    }
