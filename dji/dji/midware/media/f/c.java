...
public class c {
    ...
    public static short a(byte[] bArr) {
        return ByteBuffer.wrap(j(bArr, 2)).order(ByteOrder.BIG_ENDIAN).getShort();
    }

    public static int b(byte[] bArr) {
        return ByteBuffer.wrap(j(bArr, 4)).order(ByteOrder.BIG_ENDIAN).getInt();
    }

    public static long c(byte[] bArr) {
        return ByteBuffer.wrap(j(bArr, 8)).order(ByteOrder.BIG_ENDIAN).getLong();
    }

    public static float d(byte[] bArr) {
        return ByteBuffer.wrap(j(bArr, 4)).order(ByteOrder.BIG_ENDIAN).getFloat();
    }

    public static double e(byte[] bArr) {
        return ByteBuffer.wrap(j(bArr, 8)).order(ByteOrder.BIG_ENDIAN).getDouble();
    }

    public static short a(byte[] bArr, int i) {
        return ByteBuffer.wrap(j(bArr, 2), i, 2).order(ByteOrder.BIG_ENDIAN).getShort();
    }

    public static int b(byte[] bArr, int i) {
        return ByteBuffer.wrap(j(bArr, 4), i, 4).order(ByteOrder.BIG_ENDIAN).getInt();
    }

    public static long c(byte[] bArr, int i) {
        return ByteBuffer.wrap(j(bArr, 8), i, 8).order(ByteOrder.BIG_ENDIAN).getLong();
    }

    public static float d(byte[] bArr, int i) {
        return ByteBuffer.wrap(j(bArr, 4), i, 4).order(ByteOrder.BIG_ENDIAN).getFloat();
    }

    public static double e(byte[] bArr, int i) {
        return ByteBuffer.wrap(j(bArr, 8), i, 8).order(ByteOrder.BIG_ENDIAN).getDouble();
    }

    public static int f(byte[] bArr, int i) {
        Object obj = new byte[2];
        System.arraycopy(bArr, i, obj, 0, 2);
        return ByteBuffer.wrap(j(obj, 4), 0, 4).order(ByteOrder.BIG_ENDIAN).getInt();
    }

    public static long g(byte[] bArr, int i) {
        Object obj = new byte[4];
        System.arraycopy(bArr, i, obj, 0, 4);
        return ByteBuffer.wrap(j(obj, 8), 0, 8).order(ByteOrder.BIG_ENDIAN).getLong();
    }
