...
public class DataCameraSetFocusInfinite extends n implements e {
    private static DataCameraSetFocusInfinite a = null;
    private boolean b;
    ...
    public static synchronized DataCameraSetFocusInfinite getInstance() {
        ...
        synchronized (DataCameraSetFocusInfinite.class) {
            if (a == null) {
                a = new DataCameraSetFocusInfinite();
            }
            dataCameraSetFocusInfinite = a;
        }
        return dataCameraSetFocusInfinite;
    }

    public DataCameraSetFocusInfinite a(boolean z) {
        this.b = z;
        return this;
    }
