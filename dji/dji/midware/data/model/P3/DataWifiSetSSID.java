...
public class DataWifiSetSSID extends n implements e {
    private static DataWifiSetSSID a = null;
    ...
    public DataWifiSetSSID a(byte[] bArr) {
        this.c = bArr;
        return this;
    }

    public DataWifiSetSSID a(boolean z) {
        this.b = z;
        return this;
    }
