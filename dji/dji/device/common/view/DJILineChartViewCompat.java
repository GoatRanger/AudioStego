...
public class DJILineChartViewCompat extends View implements c {
    ...
    public DJILineChartViewCompat(Context context) {
        super(context);
    }

    public DJILineChartViewCompat(Context context, AttributeSet attributeSet) {
    ...
    protected void onFinishInflate() {
        if (!isInEditMode()) {
            ...
            this.g = resources.getColor(R.color.black_half_longan);
            this.h = resources.getColor(R.color.chart_fill_longan);
            this.i = resources.getColor(R.color.chart_line_longan);
            this.j = resources.getColor(R.color.chart_border_longan);
