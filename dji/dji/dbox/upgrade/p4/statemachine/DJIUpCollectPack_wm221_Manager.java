...
public class DJIUpCollectPack_wm221_Manager extends b {
    ...
    public DJIUpCollectPack_wm221_Manager(g gVar, Context context) {
        super(gVar, context);
        this.requestAcCfg = new b(context, DeviceType.DM368, new a(this) {
            final /* synthetic */ DJIUpCollectPack_wm221_Manager a;
