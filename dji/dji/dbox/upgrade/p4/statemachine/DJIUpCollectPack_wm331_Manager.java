...
public class DJIUpCollectPack_wm331_Manager extends b {
    ...
    public DJIUpCollectPack_wm331_Manager(final g gVar, Context context) {
        super(gVar, context);
        this.requestAcCfg = new b(context, DeviceType.DM368, new a(this) {
            final /* synthetic */ DJIUpCollectPack_wm331_Manager b;
