...
public class DJIUpCollectPack_wm330_Manager extends b {
    ...
    public DJIUpCollectPack_wm330_Manager(final g gVar, Context context) {
        super(gVar, context);
        this.requestAcCfg = new b(context, DeviceType.DM368, new a(this) {
            final /* synthetic */ DJIUpCollectPack_wm330_Manager b;
