...
public class DJIWorkingTextView extends TextView {
    private static final String b = "DJILPWorkingTextView";
    Runnable a = new Runnable(this) {
        final /* synthetic */ DJIWorkingTextView a;
    ...
    public DJIWorkingTextView(Context context, AttributeSet attributeSet) {
