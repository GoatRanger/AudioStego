...
import dji.phone.widget.DJILPWorkingTextView;
import dji.pilot.fpv.R;
import java.util.List;

public class a extends BaseAdapter {
    private static final String a = "BleListAdapter";
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            b bVar2 = new b();
            inflate = this.b.inflate(R.layout.lp_ble_list_item_ly, null);
            bVar2.a = (TextView) inflate.findViewById(R.id.lp_ble_name_tv);
            bVar2.b = (DJILPWorkingTextView) inflate.findViewById(R.id.lp_ble_status_tv);
            bVar2.c = (Button) inflate.findViewById(R.id.lp_ble_action_btn);
        ...
        if (bVar3 != null) {
            ...
            if (bVar3.f == c.BLE_DEVICE_CONNECTED) {
                bVar.b.stopWorking();
                bVar.b.setText(R.string.lp_ble_device_connected);
            } else if (bVar3.f == c.BLE_DEVICE_CONNECTING) {
                bVar.c.setText(R.string.lp_ble_device_connecting);
                bVar.b.setVisibility(0);
                bVar.b.startWorking();
                bVar.c.setVisibility(8);
            } else if (bVar3.f == c.BLE_DEVICE_DISCONNECTED) {
