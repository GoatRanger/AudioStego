...
public class FreqSnrSdrView extends DJIImageView implements OnGestureListener, OnTouchListener {
    ...
    public FreqSnrSdrView(Context context, AttributeSet attributeSet) {
        ...
        if (!isInEditMode()) {
            ...
            this.K = context.getResources().getColor(R.color.setting_ui_hd_fq_gray);
            this.L = context.getResources().getColor(R.color.setting_ui_hd_fq_white);
            this.M = context.getResources().getColor(R.color.setting_ui_hd_fq_green);
            this.N = context.getResources().getColor(R.color.setting_ui_hd_fq_red);
            this.O = context.getResources().getColor(R.color.setting_ui_hd_fq_blue);
            this.Q = context.getResources().getColor(R.color.setting_ui_hd_fq_white_alpha);
            clean();
            this.I = new Paint();
            ...
            a();
            this.G = context.getString(R.string.setting_ui_hd_freq_snr_channel);
            this.H = context.getString(R.string.setting_ui_hd_freq_snr_rssi);
    ...
    public void onEventBackgroundThread(DataWifiGetPushSweepFrequency dataWifiGetPushSweepFrequency) {
        ...
        while (length < iArr.length) {
            iArr3[i2] = iArr[length] == -100 ? -99 : iArr[length];
            if (iArr3[i2] > -60) {
                iArr3[i2] = -60;
            }
            length++;
        ...
        if (a) {
            while (i < iArr2.length) {
                iArr3[i2] = iArr2[i] == -100 ? -99 : iArr2[i];
                if (iArr3[i2] > -60) {
                    iArr3[i2] = -60;
                }
                i++;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.I != null) {
            ...
            if (!this.E) {
                ...
                canvas.drawText(getContext().getString(R.string.setting_ui_hd_freq_snr_none), (float) (this.s / 2), (float) ((this.r / 2) + 40), this.I);
            } else if (this.P) {
