...
public class LowVoltageAction extends ItemViewSpinner {
    public static final String a = "g_config.voltage.level_1_protect_type_0";
    private int b = 0;
    private boolean c = false;

    public LowVoltageAction(Context context, AttributeSet attributeSet) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            this.c = true;
            String[] strArr = new String[]{getContext().getString(R.string.setting_ui_battery_non_smart_low_voltage_action_go_home), getContext().getString(R.string.setting_ui_battery_non_smart_low_voltage_action_landing), getContext().getString(R.string.setting_ui_battery_non_smart_low_voltage_action_led_warning)};
    ...
    public void onItemClick(final int i) {
        ...
        dataFlycSetParams.start(new dji.midware.e.d(this) {
            final /* synthetic */ LowVoltageAction b;
    ...
    private void a() {
        if (this.c) {
            new DataFlycGetParams().setInfos(new String[]{a}).start(new dji.midware.e.d(this) {
                final /* synthetic */ LowVoltageAction a;
                ...
                public void onSuccess(Object obj) {
                    this.a.f.post(new Runnable(this) {
                        ...
                        public void run() {
                            this.a.a.b = d.read(LowVoltageAction.a).value.intValue();
