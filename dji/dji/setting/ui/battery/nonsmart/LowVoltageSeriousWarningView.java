...
public class LowVoltageSeriousWarningView extends ItemViewSeekbar {
    public static final String[] a = new String[]{"g_config.voltage.level_2_protect_0", "g_config.voltage.battery_cell_0"};
    private boolean e = false;
    private int f = 0;
    private int g = 0;
    private int h = 0;

    public LowVoltageSeriousWarningView(Context context, AttributeSet attributeSet) {
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        dataFlycSetParams.start(new d(this) {
            final /* synthetic */ LowVoltageSeriousWarningView b;
    ...
    private void c() {
        new DataFlycGetParams().setInfos(a).start(new d(this) {
            final /* synthetic */ LowVoltageSeriousWarningView a;
            ...
            public void onSuccess(Object obj) {
                this.a.d.post(new Runnable(this) {
                    ...
                    public void run() {
                        int intValue = dji.midware.data.manager.P3.d.read(LowVoltageSeriousWarningView.a[1]).value.intValue();
                        this.a.a.h = dji.midware.data.manager.P3.d.read(LowVoltageSeriousWarningView.a[0]).value.intValue();
