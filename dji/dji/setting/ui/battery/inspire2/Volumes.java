...
public class Volumes extends DividerLinearLayout implements OnClickListener, d {
    private static final int[] a = new int[]{R.id.battery_sub1_ly, R.id.battery_sub2_ly};
    private final Drawable[] b = new Drawable[2];
    ...
    private void a() {
        dji.setting.a.a.a((View) this, R.layout.setting_ui_battery_volume_inspire2);
        if (!isInEditMode()) {
