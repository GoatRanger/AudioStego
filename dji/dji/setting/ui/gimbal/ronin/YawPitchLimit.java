...
public class YawPitchLimit extends LinearLayout {
    private static final String[] a = new String[]{"ronin_pitch_up", "ronin_pitch_down", "ronin_yaw_left", "ronin_yaw_right"};
    private boolean b = false;
    private List<TextView> c = new ArrayList();
    private OnClickListener d = new OnClickListener(this) {
        final /* synthetic */ YawPitchLimit a;
        ...
        public void onClick(View view) {
            ...
            for (int i3 = 0; i3 < this.a.c.size(); i3++) {
                if (view == this.a.c.get(i3)) {
                    ...
                    ParamInfo read = e.read(YawPitchLimit.a[i3]);
        ...
        public void a(TextView textView, int i) {
            ...
            while (i2 < this.a.c.size()) {
                if (textView != this.a.c.get(i2)) {
                    i2++;
                } else if (this.a.a((TextView) this.a.c.get(i2), Integer.valueOf(i), YawPitchLimit.a[i2])) {
                    DataGimbalSetUserParams.getInstance().a(YawPitchLimit.a[i2], Integer.valueOf(i)).start(new d(this) {
    ...
    public YawPitchLimit(Context context, AttributeSet attributeSet) {
    ...
    protected void onFinishInflate() {
        if (!isInEditMode()) {
            this.c.add((TextView) findViewById(R.id.setting_ui_ronin_pitch_up_tv));
            this.c.add((TextView) findViewById(R.id.setting_ui_ronin_pitch_down_tv));
            this.c.add((TextView) findViewById(R.id.setting_ui_ronin_yaw_left_tv));
            this.c.add((TextView) findViewById(R.id.setting_ui_ronin_yaw_right_tv));
    ...
    private void c() {
        ((TextView) this.c.get(0)).post(new Runnable(this) {
            ...
            public void run() {
                for (int i = 0; i < YawPitchLimit.a.length; i++) {
                    ((TextView) this.a.c.get(i)).setText(String.format("%d", new Object[]{Integer.valueOf(e.read(YawPitchLimit.a[i]).value.intValue())}));
                }
            }
        });
    }
