...
public class f {
    ...
    private Context b;
    private Map<dji.playback.entryActivity.d.a, Boolean> c;
    private a d;
    private Handler e;
    ...
    public f(Context context, Map<dji.playback.entryActivity.d.a, Boolean> map) {
        this(context);
        this.c = map;
    }
    ...
    public void a(dji.playback.entryActivity.d.a aVar) {
        synchronized (this.c) {
    ...
    public void a(List<dji.playback.entryActivity.d.a> list) {
        for (dji.playback.entryActivity.d.a a : list) {
            a(a);
        }
        a();
    }
        ...
        synchronized (this.c) {
            for (Entry entry : this.c.entrySet()) {
                if (!((Boolean) entry.getValue()).booleanValue()) {
                    dji.playback.entryActivity.d.a aVar = (dji.playback.entryActivity.d.a) entry.getKey();
    ...
    private void a(String str, String str2, final dji.playback.entryActivity.d.a aVar) {
