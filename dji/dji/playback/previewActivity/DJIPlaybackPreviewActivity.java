...
public class DJIPlaybackPreviewActivity extends FinalActivity {
    public static int a;
    public static int b;
    private c c;
    ...
    protected void onCreate(Bundle bundle) {
        DJILogHelper.getInstance().LOGI("bob", "DJIPlaybackPreviewActivity onCreate");
        Bundle extras = getIntent().getExtras();
        super.onCreate(bundle);
        setContentView(R.layout.v2_playbackpreview_activity);
        a();
        ...
        if (parcelableArrayList != null) {
            DJILogHelper.getInstance().LOGI("bob", "DJIPlaybackPreviewActivity size = " + ((List) parcelableArrayList.get(0)).size());
        }
