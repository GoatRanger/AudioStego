...
import dji.playback.previewActivity.widget.DJIPlaybackHScrollView;
...
public class d extends PagerAdapter {
    ...
    public class a implements Callback {
        ...
        public PhotoView c;
        public int d;
        public dji.playback.entryActivity.d.b e;
        public h f;
        public DJIPlaybackHScrollView g;
        ...
        public dji.playback.previewActivity.widget.DJIPlaybackHScrollView.a q;
        final /* synthetic */ d r;
        ...
        public void a(int i, int i2) {
            ...
            if (this.g.getVisibility() == 0) {
                this.g.smoothScrollTo((int) ((((long) i) * ((long) this.g.getTotalWidth())) / ((long) i2)), 0);
                int i3 = i / 60000;
                int i4 = (i % 60000) / 1000;
        ...
        public void e() {
            ...
            this.b.setVisibility(0);
            this.r.e.postDelayed(new Runnable(this) {
                final /* synthetic */ a a;
        ...
        public void a(final h hVar, final int i) {
            ...
            if (hVar.h == dji.playback.entryActivity.d.b.Type_IMG) {
                ...
                dji.playback.entryActivity.b.getInstance().c(hVar.c, this.c);
            } else {
                this.q = new dji.playback.previewActivity.widget.DJIPlaybackHScrollView.a(this) {
                    final /* synthetic */ a a;
                ...
                this.g.setVisibility(0);
                this.g.init(this.h, hVar.d, hVar.c, this.q);
                this.a.setVisibility(0);
                a(this.a, hVar.j, hVar.i);
                this.b.setVisibility(0);
                this.c.setVisibility(8);
                dji.playback.entryActivity.b.getInstance().a(hVar.c, this.a, 1, false);
            }
                ...
                public void onClick(View view) {
                    ...
                    if (this.c.r.b != null) {
                        if (this.c.a.getVisibility() == 0) {
                            ...
                            this.c.a(this.c.k, hVar.j, hVar.i);
                            this.c.k.setVisibility(0);
                            this.c.g.setVisibility(0);
                            this.c.m.setVisibility(0);
                            this.c.g.init(this.c.h, hVar.d, hVar.c, this.c.q);
            ...
            this.c.setOnViewTapListener(new OnViewTapListener(this) {
                ...
                public void onViewTap(View view, float f, float f2) {
                    if (this.c.r.b != null && this.c.e == dji.playback.entryActivity.d.b.Type_IMG) {
                        this.c.r.b.a(hVar, i);
                    }
                }
            });
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        ...
        if (this.f.size() <= 0) {
            View inflate = ((LayoutInflater) viewGroup.getContext().getSystemService("layout_inflater")).inflate(R.layout.v2_playbackpreview_pager, null);
            a aVar = new a(this);
            ...
            aVar.g = (DJIPlaybackHScrollView) inflate.findViewById(R.id.gk);
