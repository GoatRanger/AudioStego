...
import dji.playback.previewActivity.widget.DJIPlaybackHScrollView.a;
...
public class DJIPlaybackVideoActivity extends DJIBaseActivity implements Callback {
    ...
    private Boolean F;
    private Timer G;
    protected DJIPlaybackHScrollView h;
    ...
    private void a() {
        this.z = (RelativeLayout) findViewById(R.id.cxt);
        ...
        this.A.setOnClickListener(new OnClickListener(this) {
            final /* synthetic */ DJIPlaybackVideoActivity a;
    ...
    private void c() {
        ...
        this.h = (DJIPlaybackHScrollView) findViewById(R.id.gk);
