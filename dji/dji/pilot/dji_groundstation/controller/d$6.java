...
class d$6 implements d {
    ...
    public void onSuccess(Object obj) {
        ...
        if (result != 0) {
            d.a(this.a, R.string.gsnew_gs_home_lock_send_command_failed, c.a(result), "");
        } else if (i.getInstance().c().value() == ProductType.A2.value()) {
            this.a.a(dji.pilot.dji_groundstation.a.d.c.r);
            b.getInstance().b(true);
            this.a.a(g.EVENT_SMARTMODE_SWITCH_HOMELOCK_STATUS, null);
        } else {
            ...
            DataFlycFunctionControl.getInstance().start(new d(this) {
                ...
                public void onSuccess(Object obj) {
                    this.a.a.a(dji.pilot.dji_groundstation.a.d.c.r);
                    b.getInstance().b(true);
                    this.a.a.a(g.EVENT_SMARTMODE_SWITCH_HOMELOCK_STATUS, null);
                }

                public void onFailure(a aVar) {
                    if (this.a.a.b().ordinal() == dji.pilot.dji_groundstation.a.d.c.r.ordinal()) {
                        b.getInstance().b(true);
                        this.a.a.a(g.EVENT_SMARTMODE_SWITCH_HOMELOCK_STATUS, null);
                        return;
                    }
                    d.a(this.a.a, R.string.gsnew_gs_home_lock_send_command_failed, -1, aVar.toString());
                }
            });
        }
    }
    ...
    public void onFailure(a aVar) {
        d.a(this.a, R.string.gsnew_gs_home_lock_send_command_failed, -1, aVar.toString());
    }
}
