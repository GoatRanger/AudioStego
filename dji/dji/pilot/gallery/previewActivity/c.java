...
import dji.pilot.R;
import dji.pilot.gallery.entryActivity.d;
import dji.pilot.gallery.entryActivity.e;
import dji.pilot.gallery.entryActivity.g;
import dji.pilot.gallery.previewActivity.b.a;
import dji.pilot.gallery.previewActivity.b.b;
import dji.pilot.gallery.previewActivity.widget.DJISliderbar;
...
public class c extends Fragment implements b {
    ...
    private final Runnable M = new Runnable(this) {
        ...
        public void run() {
            if (this.a.G != null) {
                this.a.G.setSystemUiVisibility(4871);
            }
        }
    };
    WakeLock c;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (arguments != null) {
            ...
            if (parcelableArrayList != null) {
                ...
                DJILogHelper.getInstance().LOGI("bob", "DJIGalleryPreviewFragment size = " + this.f.size() + " index= " + this.e);
            }
        }
    ...
    private void a(View view) {
        this.m = (RelativeLayout) view.findViewById(R.id.ge);
        ...
        if (this.f != null) {
            this.p.setText(a(((g) this.f.get(this.e)).e));
        }
        ...
        this.q.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View view) {
                g gVar = (g) this.a.f.get(this.a.e);
                if (gVar.h == d.b.Type_IMG) {
                    Intent intent = new Intent();
                    intent.setClass(this.a.getActivity(), DJIPhotoEditorActivity.class);
                    intent.putExtra("key_filepath", gVar.c);
    ...
    private void b(View view) {
        ...
        this.w.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    DJILogHelper.getInstance().LOGI("bob", "width =   " + gVar.j + " height=" + gVar.i);
        ...
        this.x.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View view) {
                dji.pilot.gallery.entryActivity.c.a(this.a.getActivity(), ((g) this.a.f.get(this.a.e)).h, new dji.pilot.gallery.entryActivity.c.a(this) {
                    ...
                    public void a() {
                        ...
                        g gVar = (g) this.a.a.f.remove(this.a.a.e);
                        if (gVar.h.equals(d.b.Type_IMG)) {
                            dji.thirdparty.a.c.a().e(e.a.EventHGPhotoDel);
                        } else if (gVar.h.equals(d.b.Type_VIDEO)) {
                            dji.thirdparty.a.c.a().e(new e.b());
                        }
                        File file = new File(gVar.c);
                        if (!(!file.exists() || file.isDirectory() || file.delete())) {
                            DJILogHelper.getInstance().LOGI("bob", "deleteFile false");
                        }
                        if (size <= 1) {
        ...
        this.t.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View view) {
                ...
                if (b != null) {
                    Object tag = b.getTag();
                    if (tag == null || !(tag instanceof d.a)) {
                        DJILogHelper.getInstance().LOGI("bob", "bottom click o = null || o !instanceof DJIGalleryPreviewPagerAdapter.ConfigureHolder");
                        return;
                    } else if (this.a.H) {
                        d.a aVar = (d.a) tag;
                        if (!aVar.a()) {
                            ...
                            this.a.z = ((g) this.a.f.get(this.a.e)).c;
                            this.a.g.setPagingEnabled(false);
                            if (this.a.B) {
                                this.a.c();
                                this.a.b(0);
                        ...
                        g gVar2 = (g) this.a.f.get(this.a.e);
                        Intent intent = new Intent(this.a.getActivity(), DJIGalleryVideoActivity.class);
                        intent.putExtra("title", gVar2.e);
                        intent.putExtra("duration", gVar2.d);
                        intent.putExtra("path", gVar2.c);
                        intent.putExtra("width", gVar2.j);
                        intent.putExtra("height", gVar2.i);
                        this.a.startActivity(intent);
                        return;
                    }
                }
            ...
            public void a(g gVar, int i, int i2) {
                ...
                if (this.a.H) {
                    ...
                    if (b != null) {
                        Object tag = b.getTag();
                        if (tag == null || !(tag instanceof d.a)) {
                            DJILogHelper.getInstance().LOGI("bob", "onVideoImageClicked bottom click o = null || o !instanceof DJIGalleryPreviewPagerAdapter.ConfigureHolder");
                            return;
                        }
                        d.a aVar = (d.a) tag;
                        if (this.a.z == null) {
                ...
                intent.putExtra("width", gVar.j);
                intent.putExtra("height", gVar.i);
                this.a.startActivity(intent);
            }
            ...
            public void a(int i, int i2, int i3, int i4) {
                ...
                if (this.a.y != null && !this.a.y.isPlaying() && this.a.h != null) {
                    ...
                    if (tag instanceof d.a) {
                        d.a aVar = (d.a) tag;
                        int scrollX = (aVar.g.getScrollX() * aVar.f.d) / aVar.g.getTotalWidth();
    ...
    private void c(View view) {
        this.g = (DJINonViewPager) view.findViewById(R.id.ah6);
        a();
    ...
    private void b(int i) {
        if (i != 1) {
            this.t.setImageResource(R.drawable.gallery_preview_pause);
    ...
    private void c(int i) {
        if (i == 0) {
            ...
            this.t.setImageResource(R.drawable.gallery_preview_playsmall);
        } else if (this.m.getVisibility() == 0) {
            this.m.clearAnimation();
            this.m.startAnimation(this.i);
            this.n.clearAnimation();
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate;
        if (getResources().getConfiguration().orientation == 2) {
            inflate = layoutInflater.inflate(R.layout.gallery_preview_fragment_land, viewGroup, false);
        } else {
            inflate = layoutInflater.inflate(R.layout.gallery_preview_fragment, viewGroup, false);
        }
        d(inflate);
        this.G = inflate;
        return inflate;
    ...
    public void onResume() {
        ...
        new Handler(getActivity().getMainLooper()).postDelayed(new Runnable(this) {
            final /* synthetic */ c a;
            ...
            public void run() {
                if (this.a.L == 0) {
                    this.a.L = this.a.g();
                    DJILogHelper.getInstance().LOGI("bob", "getStatusBarHeight() = " + this.a.g() + " mHeadbarView.getHeight()=" + this.a.m.getHeight());
