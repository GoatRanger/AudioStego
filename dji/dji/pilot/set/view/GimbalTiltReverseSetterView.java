...
public class GimbalTiltReverseSetterView extends SetSwitchView {
    ...
    public GimbalTiltReverseSetterView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.i = null;
        this.k = new Handler(new Callback(this) {
            final /* synthetic */ GimbalTiltReverseSetterView a;
    ...
    private void b() {
        ...
        this.j.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                boolean z = true;
                GimbalTiltReverseSetterView gimbalTiltReverseSetterView = this.a;
                if (this.a.j.getTiltDirection() != 1) {
                    z = false;
                }
                gimbalTiltReverseSetterView.d = z;
    ...
    protected void a() {
        ...
        this.i.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                ...
                if (parseLong != 0 && parseLong >= GimbalTiltReverseSetterView.g) {
