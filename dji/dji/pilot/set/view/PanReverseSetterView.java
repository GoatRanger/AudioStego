...
public class PanReverseSetterView extends SetSwitchView {
    ...
    public PanReverseSetterView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.i = null;
        this.k = new Handler(new Callback(this) {
            final /* synthetic */ PanReverseSetterView a;
    ...
    private void b() {
        ...
        this.j.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                boolean z = true;
                PanReverseSetterView panReverseSetterView = this.a;
                if (this.a.j.getPanDirection() != 1) {
                    z = false;
                }
                panReverseSetterView.d = z;
    ...
    protected void a() {
        ...
        this.i.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                ...
                if (parseLong != 0 && parseLong >= PanReverseSetterView.g) {
