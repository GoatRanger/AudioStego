...
public class GimbalZoom2SpeedSetterView extends SetSwitchView {
    ...
    public GimbalZoom2SpeedSetterView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.i = null;
        this.k = new Handler(new Callback(this) {
            final /* synthetic */ GimbalZoom2SpeedSetterView a;
    ...
    private void b() {
        ...
        this.j.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                this.a.d = this.a.j.getZoom2SpeedEnable();
        ...
        if (b.o(null)) {
            ...
            this.i.start(new d(this) {
                ...
                public void onSuccess(Object obj) {
                    ...
                    if (parseLong != 0 && parseLong >= GimbalZoom2SpeedSetterView.g) {
    ...
    protected void setValue(boolean z) {
        ...
        dataGimbalSetHandleParams.f(i).start(new d(this) {
            final /* synthetic */ GimbalZoom2SpeedSetterView a;
    ...
    protected int getTitleId() {
        return R.string.set_gimbal_zoom2speed;
    }
}
