...
public class DJILPGimbalTiltReverseSetterView extends SetSwitchView {
    ...
    public DJILPGimbalTiltReverseSetterView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.i = null;
        this.k = new Handler(new Callback(this) {
            final /* synthetic */ DJILPGimbalTiltReverseSetterView a;
    ...
    private void b() {
        ...
        this.j.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                boolean z = true;
                DJILPGimbalTiltReverseSetterView dJILPGimbalTiltReverseSetterView = this.a;
                if (this.a.j.getTiltDirection() != 1) {
                    z = false;
                }
                dJILPGimbalTiltReverseSetterView.d = z;
    ...
    protected void a() {
        ...
        this.i.start(new d(this) {
            ...
            public void onSuccess(Object obj) {
                ...
                if (parseLong != 0 && parseLong >= DJILPGimbalTiltReverseSetterView.g) {
    ...
    protected void setValue(boolean z) {
        ...
        dataGimbalSetHandleParams.b(i).start(new d(this) {
            final /* synthetic */ DJILPGimbalTiltReverseSetterView a;
    ...
    protected int getTitleId() {
        return R.string.set_gimbal_tilt_reverse;
    }
}
