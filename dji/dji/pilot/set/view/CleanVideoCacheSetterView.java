...
public class CleanVideoCacheSetterView extends SetButtonView {
    public CleanVideoCacheSetterView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public void onClick(View view) {
        e.a(getContext(), R.string.fpv_gensetting_videocache_clearbuffer_comfirm, new OnClickListener(this) {
            final /* synthetic */ CleanVideoCacheSetterView a;
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                e.c(this.a.getContext(), R.string.fpv_gensetting_videocache_clearbuffer_done);
            }
        });
    }

    protected int getTitleId() {
        return R.string.fpv_gensetting_videocache_clear;
    }

    protected int getButtonStringId() {
        return R.string.set_videocache_clear_start;
    }
