package dji.thirdparty.gson.reflect;

import dji.thirdparty.gson.internal.$Gson.Preconditions;
import dji.thirdparty.gson.internal.$Gson.Types;
...
public class TypeToken<T> {
    ...
    public boolean isAssignableFrom(Type type) {
        ...
        } else if (this.rawType.isAssignableFrom(Types.getRawType(type)) && isAssignableFrom(type, (GenericArrayType) this.type)) {
            return true;
        } else {
            return false;
        }
