...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> map) throws IOException {
            ...
            if (map == null) {
                ...
                for (Entry entry : map.entrySet()) {
                    JsonElement access$1 = MapTypeAdapterFactory.toJsonTree(this.keyTypeAdapter, entry.getKey());
                    arrayList.add(access$1);
                    arrayList2.add(entry.getValue());
                    int i3 = (access$1.isJsonArray() || access$1.isJsonObject()) ? 1 : 0;
                    i2 = i3 | i2;
                }
                if (i2 != 0) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        ObjectConstructor constructor = this.constructorConstructor.getConstructor(typeToken);
        return new Adapter(gson, mapKeyAndValueTypes[0], keyAdapter, mapKeyAndValueTypes[1], adapter, constructor);
    }
    ...
    private static <T> JsonElement toJsonTree(TypeAdapter<T> typeAdapter, T t) {
        try {
