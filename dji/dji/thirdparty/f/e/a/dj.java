...
public final class dj<T, U> implements d$g<d<T>, T> {
    ...
    static final class b<T> extends k<T> {
        ...
        L_0x0069:
            ...
            goto L_0x003f;
            */
            throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.f.e.a.dj.b.a_(java.lang.Object):void");
        }
        ...
        public void a(Throwable th) {
            synchronized (this.b) {
                if (this.e) {
                    this.f = Collections.singletonList(dj.c.a(th));
                    return;
                }
                this.f = null;
                this.e = true;
        ...
        L_0x0014:
            r0 = r6.f;	 Catch:{ all -> 0x004f }
            r1 = dji.thirdparty.f.e.a.dj.b;	 Catch:{ all -> 0x004f }
        ...
        L_0x006b:
            ...
            goto L_0x0041;
            */
            throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.f.e.a.dj.b.f():void");
        }
