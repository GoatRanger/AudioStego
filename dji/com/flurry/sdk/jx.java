...
public class jx {
    public static boolean a() {
        return ((KeyguardManager) hz.a().c().getSystemService("keyguard")).inKeyguardRestrictedInputMode();
    }

    @SuppressLint({"NewApi"})
    public static Point b() {
        Display defaultDisplay = ((WindowManager) hz.a().c().getSystemService("window")).getDefaultDisplay();
