...
public class kd {
    private static final Pattern a = Pattern.compile(d.t);
    ...
    public static String b(String str) {
        ...
        i = a(i.getScheme(), i.getAuthority(), d.t, null, null);
        if (i != null) {
            return i.toString();
        }
        return str;
    ...
    public static boolean h(String str) {
        ...
        if (i.getScheme() == null || "http".equalsIgnoreCase(i.getScheme()) || b.a.equalsIgnoreCase(i.getScheme())) {
            return true;
        }
        return false;
    }
