...
class m implements Runnable {
    ...
    public void run() {
        try {
            ...
            long j3 = (long) a.f;
            Object obj2 = null;
            long j4 = j3 < Options.DEFAULT_DESIRED_INTERVAL ? Options.DEFAULT_DESIRED_INTERVAL : j3;
            ...
            channelException = new ChannelException(Constants.CODE_NETWORK_TIMEOUT_WAITING_TO_SEND, "TpnsMessage wait for response timeout!");
            a aVar2 = null;
            synchronized (this.a) {
