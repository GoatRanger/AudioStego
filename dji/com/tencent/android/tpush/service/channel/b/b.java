    ...
    protected int b(OutputStream outputStream) {
        ...
        if (bArr == null) {
            ...
            try {
                ...
                String str = "POST " + this.f + " HTTP/1.1" + DebugFile.EOL;
                String str2 = str;
                for (Entry entry : this.g.entrySet()) {
                    str2 = str2 + ((String) entry.getKey()) + ": " + ((String) entry.getValue()) + DebugFile.EOL;
                }
                Object bytes = (str2 + DebugFile.EOL).getBytes("UTF-8");
