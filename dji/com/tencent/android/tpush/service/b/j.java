    ...
    public void a(Context context, long j, String str) {
        if (context != null && !e.a(str)) {
            try {
                ...
                arrayList.add(str);
                String equals2 = arrayList.toString().replace(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "").replace("\t", "");
        ...
        if (context != null && str != null && str.length() != 0) {
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    String replace = a.toString().replace(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "").replace("\t", "");
