...
class i implements b {
    ...
    public void a(SocketChannel socketChannel, StrategyItem strategyItem) {
        ...
        if (!socketChannel.isConnected() || q.i().c()) {
            if (!socketChannel.isConnected() && !q.i().c()) {
                g.a(this.a, Constants.CODE_NETWORK_CREATE_OPTIOMAL_SC_FAILED, "create channel fail httpChannelCallback !");
            }
    ...
    public void a(StrategyItem strategyItem) {
        if (!q.i().b() && !f.i().b() && g.d(this.a) == 0) {
            g.a(this.a, 2);
            if (g.b(this.a) != null) {
                g.b(this.a).a((int) Constants.CODE_NETWORK_CREATE_OPTIOMAL_SC_FAILED, "create http channel fail!");
            }
        }
    }
}
