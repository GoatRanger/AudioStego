...
public class g {
    ...
    private void a(String str) {
        ...
        if (!a.d(l.e())) {
            ...
            a((int) Constants.CODE_NETWORK_UNREACHABLE, "network can't reachable!");
        } else if (q.i().b() || f.i().b()) {
            ...
            CacheManager.removeOptStrategyList(l.e(), str);
            List serverItems;
            try {
                List<StrategyItem> b;
                List arrayList;
                ...
                if (str.equals("3") || str.equals("1") || str.equals("2")) {
                    serverItems = CacheManager.getServerItems(l.e(), str);
                    if (serverItems == null) {
                        serverItems = new ArrayList();
                    }
                    serverItems.addAll(DefaultServer.a());
                    switch (Tools.getChannelType(l.e())) {
                        case 1:
                            try {
                                ...
                                a((int) Constants.CODE_NETWORK_CREATE_OPTIOMAL_SC_FAILED, "create tcp channel fail!");
                                return;
                            } catch (Exception e2) {
                        ...
                        case 2:
                            try {
                                ...
                                a((int) Constants.CODE_NETWORK_CREATE_OPTIOMAL_SC_FAILED, "create http channel fail!");
                                return;
                            } catch (Exception e22) {
                        ...
                        case 3:
                            try {
                                ...
                                a((int) Constants.CODE_NETWORK_CREATE_OPTIOMAL_SC_FAILED, "create wap channel fail!");
                                return;
                        ...
                        default:
                            try {
                                ...
                                try {
                                    ...
                                    a((int) Constants.CODE_NETWORK_CREATE_OPTIOMAL_SC_FAILED, "create default channel fail!");
                                    arrayList = null;
                                    q.i().a(this.p);
                                    q.i().a(serverItems);
                                    q.i().g();
    ...
    public void b() {
        m++;
        if (m < com.tencent.android.tpush.service.a.a.t) {
            a().a(e.g(l.e()));
        } else {
