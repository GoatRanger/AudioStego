...
public class DefaultServer {
    ...
    public static ArrayList a(String str) {
        ...
        if (str.equals(String.valueOf(3))) {
            ...
            String hostAddress;
            String domain = CacheManager.getDomain(l.e());
    ...
    public static void a(ApList apList) {
        ...
        for (Byte b : map.keySet()) {
            String a = e.a(((Long) map.get(b)).longValue());
        ...
        for (Byte b2 : map2.keySet()) {
            String a2 = e.a(((Long) map2.get(b2)).longValue());
        ...
        if (!arrayList2.isEmpty()) {
            CacheManager.addServerItems(l.e(), "3", arrayList2);
        }
        if (!arrayList3.isEmpty()) {
            CacheManager.addServerItems(l.e(), "1", arrayList3);
        }
        if (!arrayList4.isEmpty()) {
            CacheManager.addServerItems(l.e(), "2", arrayList4);
        }
        ...
        CacheManager.saveSpeedTestList(l.e(), arrayList6);
        String str = apList.domain;
        if (!TextUtils.isEmpty(str) && !str.equals(CacheManager.getDomain(l.e()))) {
            CacheManager.clearDomainServerItem(l.e());
            CacheManager.saveDomain(l.e(), str);
        }
    }
