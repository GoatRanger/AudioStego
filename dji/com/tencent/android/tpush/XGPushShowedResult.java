...
public class XGPushShowedResult implements XGIResult {
    ...
    public String toString() {
        ...
        stringBuilder.append("XGPushShowedResult [msgId=").append(this.a).append(", title=").append(this.b).append(", content=").append(this.c).append(", customContent=").append(this.d).append(", activity=").append(this.e).append(", notificationActionType").append(this.g).append(d.H);
