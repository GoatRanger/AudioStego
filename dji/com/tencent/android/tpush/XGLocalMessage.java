...
public class XGLocalMessage {
    ...
    public String toString() {
        ...
        stringBuilder.append("XGLocalMessage [type=").append(this.b).append(", title=").append(this.c).append(", content=").append(this.d).append(", date=").append(this.e).append(", hour=").append(this.f).append(", min=").append(this.g).append(", builderId=").append(this.w).append(d.H);
