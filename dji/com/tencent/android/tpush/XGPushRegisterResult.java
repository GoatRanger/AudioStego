...
public class XGPushRegisterResult implements XGIResult {
    ...
    public String toString() {
        ...
        stringBuilder.append("TPushRegisterMessage [accessId=").append(this.a).append(", deviceId=").append(this.b).append(", account=").append(this.c).append(", ticket=").append(this.d).append(", ticketType=").append(this.e).append(", token=").append(this.f).append(d.H);
