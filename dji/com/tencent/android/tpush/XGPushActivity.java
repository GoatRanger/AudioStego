...
@c(a = 1, b = 3, c = "20150316", e = {a.ACTIVITYCHECK, a.INTENTCHECK, a.INTENTSCHEMECHECK}, f = "确认已进行安全校验")
public class XGPushActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (XGPushConfig.enableDebug) {
                com.tencent.android.tpush.a.a.d(Constants.LogTag, "XGPushActivity receiver intent:" + intent);
            }
    ...
    private void pushClickedResult(Intent intent) {
        ...
        if (XGPushConfig.enableDebug) {
            com.tencent.android.tpush.a.a.d(Constants.PushMessageLogTag, "activity intent =" + intent + "activity = " + stringExtra + "intent.getFlags()" + intent.getFlags());
        }
    ...
    private void showAlertDialog(int i, Intent intent) {
        if (i == 0) {
            ...
            openIntent(intent);
        } else if (intent.getIntExtra(Constants.FLAG_ACTION_CONFIRM, 0) == 1) {
    ...
    private void openIntent(Intent intent) {
        ...
        try {
            ...
            com.tencent.android.tpush.a.a.c(Constants.LogTag, "openIntent error.", e2);
            return;
        }
        broadcastToTPushService(intent);
