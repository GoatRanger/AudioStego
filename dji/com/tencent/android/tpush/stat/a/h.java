        ...
        try {
            ...
            if (externalStorageState != null && externalStorageState.equals("mounted")) {
                ...
                if (externalStorageState != null) {
                    ...
                    return String.valueOf((((long) statFs.getBlockSize()) * ((long) statFs.getAvailableBlocks())) / 1000000) + d.t + String.valueOf((((long) statFs.getBlockCount()) * ((long) statFs.getBlockSize())) / 1000000);
                }
            }
        } catch (Throwable th) {
            Log.e("XgStat", "", th);
