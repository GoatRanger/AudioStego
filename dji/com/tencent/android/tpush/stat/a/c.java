...
class c {
    ...
    void a(JSONObject jSONObject, Thread thread) {
        if (thread == null) {
            ...
            if (e.b(this.o) && this.o.split(d.t).length == 2) {
                h.a(jSONObject, "fram", this.o.split(d.t)[0]);
            }
            if (e.b(this.p) && this.p.split(d.t).length == 2) {
                h.a(jSONObject, "from", this.p.split(d.t)[0]);
            }
        ...
        h.a(jSONObject, com.alipay.sdk.h.a.j, this.a);
        h.a(jSONObject, "ch", com.tencent.android.tpush.stat.event.d.f);
        h.a(jSONObject, "mf", this.f);
        h.a(jSONObject, com.alipay.sdk.h.a.h, e.a(this.m, this.n));
