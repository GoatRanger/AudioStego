...
public class ab {
        ...
        synchronized (ab.class) {
            if (!(k || context == null)) {
                try {
                    ...
                    g = a.E();
                    h = a.i();
                    j = i.getFilesDir().getPath() + d.t + "buglylog_" + g + "_" + h + ".txt";
                    l = Process.myPid();
                } catch (Throwable th) {
                    if (a) {
                        th.printStackTrace();
    ...
    private static String a(String str, String str2, String str3, int i) {
        ...
        d.append(b.format(new Date())).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(l).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(i).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(str).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(str2).append(": ").append(str3).append("\u0001\r\n");
        return d.toString();
    }
