...
public class x implements u, Runnable {
    ...
    public x(Context context, aw awVar, a aVar, c cVar, t tVar, w wVar) {
        this.a = context;
        this.f = aVar;
        this.b = awVar;
        this.g = cVar;
    ...
    protected void a(boolean z, int i, String str) {
        if (z) {
            ...
            c.a().b(this.b.g + " end " + i + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + str);
        }
        if (this.d + this.e > 0) {
    ...
    protected boolean a(ax axVar, a aVar, c cVar) {
        if (axVar == null) {
            z.d("resp == null!", new Object[0]);
            return false;
        } else if (axVar.a != (byte) 0) {
            z.e("resp result error %d", Byte.valueOf(axVar.a));
            return false;
        } else {
            z.c("sync remote server time %s , %d", axVar.d, Long.valueOf(aVar.o()));
            aVar.f(axVar.d);
            aVar.a(aVar.o());
            if (axVar.b == 510) {
                if (axVar.c == null) {
                    z.e("remote data is miss! %d", Integer.valueOf(axVar.b));
                    return false;
                }
                az a = s.a(axVar.c);
                if (a == null) {
                    z.e("remote data is error! %d", Integer.valueOf(axVar.b));
                    return false;
                }
