...
public class w {
    ...
    protected void a(aw awVar, c cVar, int i) {
        final int i2 = i;
        this.b.b(new x(this, this.f, awVar, this.c, cVar, this.e, this) {
            final /* synthetic */ w b;

            protected void a() {
                super.a();
                this.b.a(i2, new Date().getTime());
            }
        });
    }
    ...
    public void a(List<UserInfoBean> list, c cVar, int i) {
        ...
        if (!d.e && !d.f) {
            ...
            try {
                ...
                this.b.b(new x(this, this.f, s.a(this.f, 640, a2, this.c, d), this.c, cVar, this.e, this) {
                    final /* synthetic */ w b;

                    protected void a() {
                        super.a();
                        this.b.a(2, new Date().getTime());
                    }
    ...
    public void a(List<CrashDetailBean> list, c cVar) {
        ...
        if (!d.d) {
            ...
            try {
                ...
                this.b.b(new x(this, this.f, s.a(this.f, 630, a2, this.c, d), this.c, cVar, this.e, this) {
                    final /* synthetic */ w b;
    ...
    public void a(List<CrashDetailBean> list, c cVar, long j) {
        ...
        if (cVar.b() && !d.d) {
            ...
            try {
                ...
                final List<CrashDetailBean> list2 = list;
                Thread thread = new Thread(new x(this, this.f, s.a(this.f, 630, a2, this.c, d), this.c, cVar, this.e, this) {
                    final /* synthetic */ w b;
