...
public class b {
    ...
    public b(Context context, com.tencent.bugly.crashreport.crash.b bVar, c cVar, a aVar, CrashHandleCallback crashHandleCallback) {
        this.a = context;
        this.b = bVar;
        this.c = cVar;
        this.d = aVar;
    ...
    public void b(Thread thread, String str, String str2, String str3, Map<String, String> map) {
        ...
        try {
            ...
            if (!d.d && this.c.b()) {
                ...
                a(a);
                if (!this.b.a(a)) {
                    this.b.a(a, (long) OdnpConfigStatic.MIN_ALARM_TIMER_INTERVAL);
                }
                z.e("handle end", new Object[0]);
            } else {
