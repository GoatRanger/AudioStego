...
public class c {
    ...
    protected c(Context context, q qVar, com.tencent.bugly.crashreport.common.strategy.c cVar, w wVar, a aVar, y yVar, boolean z, CrashHandleCallback crashHandleCallback) {
        ...
        this.e = new ai(a, bVar, cVar, aVar, crashHandleCallback);
        this.c = NativeCrashHandler.a(a, aVar, bVar, cVar, crashHandleCallback, yVar, z);
        this.j = new com.tencent.bugly.crashreport.crash.anr.b(a, cVar, aVar, yVar, qVar, bVar, crashHandleCallback);
        this.f = new ah(a, bVar, cVar, aVar, crashHandleCallback);
        this.g = new b(a, bVar, cVar, aVar, crashHandleCallback);
        cVar.a(this.b);
        cVar.a(this.c);
        cVar.a(this.j);
        cVar.a(this.f);
    ...
    public void a(Thread thread, String str, String str2, String str3) {
        ...
        this.h.b(new Runnable(this) {
            final /* synthetic */ c e;

            public void run() {
                try {
                    this.e.e.c(thread2, str4, str5, str6);
                } catch (Throwable th) {
                    if (!z.b(th)) {
                        th.printStackTrace();
                    }
    ...
    public void a(Thread thread, int i, String str, String str2, String str3) {
        ...
        this.h.b(new Runnable(this) {
            ...
            public void run() {
                try {
                    this.f.f.b(thread2, i2, str4, str5, str6);
                } catch (Throwable th) {
                    if (!z.b(th)) {
                        th.printStackTrace();
                    }
    ...
    public void a(Thread thread, String str, String str2, String str3, Map<String, String> map) {
        ...
        this.h.b(new Runnable(this) {
            ...
            public void run() {
                try {
                    this.f.g.b(thread2, str4, str5, str6, map2);
                } catch (Throwable th) {
                    if (!z.b(th)) {
                        th.printStackTrace();
                    }
