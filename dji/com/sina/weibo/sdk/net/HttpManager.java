                ...
                if (str2.equals("GET")) {
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            httpPost.setHeader(AsyncHttpClient.HEADER_CONTENT_TYPE, "multipart/form-data; boundary=" + BOUNDARY);
                            buildParams(byteArrayOutputStream2, weiboParameters);
                        } else {
                            obj = weiboParameters.get(d.d);
                            if (obj == null || !(obj instanceof String)) {
                                httpPost.setHeader(AsyncHttpClient.HEADER_CONTENT_TYPE, UrlEncodedParser.CONTENT_TYPE);
                            } else {
                                weiboParameters.remove(d.d);
                                httpPost.setHeader(AsyncHttpClient.HEADER_CONTENT_TYPE, (String) obj);
                            }
    ...
    public static String openUrl4RdirectURL(Context context, String str, String str2, WeiboParameters weiboParameters) throws WeiboException {
        ...
        try {
            ...
            try {
                ...
                int statusCode = execute.getStatusLine().getStatusCode();
                String value;
                if (statusCode == HttpStatusCodes.STATUS_CODE_MOVED_PERMANENTLY || statusCode == HttpStatusCodes.STATUS_CODE_FOUND) {
        ...
        synchronized (HttpManager.class) {
            ...
            if (file2.exists()) {
                ...
                try {
                    ...
                    if (firstHeader2 == null || firstHeader2.getValue().toLowerCase().indexOf(AsyncHttpClient.ENCODING_GZIP) <= -1) {
        ...
        try {
            ...
            for (String str : keySet) {
                if (weiboParameters.get(str) instanceof String) {
                    ...
                    stringBuilder.append(MP_BOUNDARY).append(DebugFile.EOL);
                    stringBuilder.append("content-disposition: form-data; name=\"").append(str).append("\"\r\n\r\n");
                    stringBuilder.append(weiboParameters.get(str)).append(DebugFile.EOL);
            ...
            for (String str2 : keySet) {
                ...
                if (obj instanceof Bitmap) {
                    ...
                    outputStream.write(DebugFile.EOL.getBytes());
            ...
            outputStream.write(new StringBuilder(DebugFile.EOL).append(END_MP_BOUNDARY).toString().getBytes());
        } catch (Throwable e) {
            throw new WeiboException(e);
        }
    }
