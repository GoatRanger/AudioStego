...
public class AidTask implements Serializable {
    ...
    public static final class AidInfo {
        ...
        public static AidInfo parseJson(String str) throws WeiboException {
            ...
            try {
                ...
                if (jSONObject.has("error") || jSONObject.has(ab.an)) {
    ...
    private String loadAidFromNet() throws WeiboException {
        ...
        try {
            str = NetUtils.internalHttpRequest(this.mContext, "https://api.weibo.com/oauth2/getaid.json", HttpMethods.GET, weiboParameters);
