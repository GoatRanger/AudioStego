...
public class ResourceManager {
    ...
    private static String getAppropriatePathOfDrawable(Context context, String str) {
        ...
        while (i < PRE_INSTALL_DRAWBLE_PATHS.length) {
            ...
            String stringBuilder = new StringBuilder(String.valueOf(PRE_INSTALL_DRAWBLE_PATHS[i])).append(d.t).append(str).toString();
        ...
        if (i3 >= 0) {
            return new StringBuilder(String.valueOf(PRE_INSTALL_DRAWBLE_PATHS[i3])).append(d.t).append(str).toString();
        }
        LogUtil.e(TAG, "Not find the appropriate path for drawable");
        return null;
    }
