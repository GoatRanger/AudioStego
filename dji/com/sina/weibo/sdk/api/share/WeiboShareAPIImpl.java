            ...
            if (baseRequest.check(this.mContext, this.mWeiboInfo, new VersionCheckHandler())) {
                ...
                if (baseRequest instanceof SendMultiMessageToWeiboRequest) {
                    try {
                        ...
                        if (sendMultiMessageToWeiboRequest.multiMessage != null) {
                            int msgType = sendMultiMessageToWeiboRequest.multiMessage.getMsgType();
                            if (msgType != 0) {
                                bundle.putInt(Msg.SHEAR_TYPE, msgType);
                            }
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
