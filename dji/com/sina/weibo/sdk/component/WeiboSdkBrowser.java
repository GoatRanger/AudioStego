...
public class WeiboSdkBrowser extends Activity implements BrowserRequestCallBack {
    ...
    private void startShare() {
        ...
        if (shareRequestParam.hasImage()) {
            ...
            new AsyncWeiboRunner(this).requestAsync(ShareRequestParam.UPLOAD_PIC_URL, shareRequestParam.buildUploadPicParam(new WeiboParameters(shareRequestParam.getAppKey())), HttpMethods.POST, new RequestListener() {
    ...
    private void setContentView() {
        ...
        this.mLoadErrorRetryBtn.setTextSize(2, b.a);
