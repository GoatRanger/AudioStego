...
class LogBuilder {
    ...
    public static String getPageLogs(CopyOnWriteArrayList<PageLog> copyOnWriteArrayList) {
        ...
        while (it.hasNext()) {
            stringBuilder.append(getLogInfo((PageLog) it.next()).toString()).append(",");
        }
    ...
    L_0x00a9:
        ...
        goto L_0x0016;
    L_0x00d2:
        r6 = (com.sina.weibo.sdk.statistic.AdEventLog) r6;	 Catch:{ Exception -> 0x002a }
        r0 = "type";
        r2 = 0;
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002a }
        r0 = "page_id";
        r2 = r6.getmImei();	 Catch:{ Exception -> 0x002a }
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002a }
        r0 = "time";
        r2 = r6.getStartTime();	 Catch:{ Exception -> 0x002a }
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002a }
        r0 = "aid";
        r2 = r6.getmAid();	 Catch:{ Exception -> 0x002a }
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002a }
        addEventData(r1, r6);	 Catch:{ Exception -> 0x002a }
        goto L_0x0016;
        */
