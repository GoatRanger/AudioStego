...
class LogReport {
            ...
            if (isNetworkConnected(context)) {
                ...
                if (validUploadLogs == null) {
                    ...
                    for (JSONArray jSONArray : validUploadLogs) {
                        HttpResponse requestHttpExecute = requestHttpExecute(mBaseUrl, HttpMethods.POST, mParams, jSONArray);
    ...
    private static HttpResponse requestHttpExecute(String str, String str2, JSONObject jSONObject, JSONArray jSONArray) {
        ...
        try {
            ...
            try {
                jSONObject.put(n.ax, System.currentTimeMillis() / 1000);
                jSONObject.put(DJIPhotoPreveiwActivity.I, jSONArray.length());
                jSONObject.put("sign", getSign(jSONObject.getString("aid"), jSONObject.getString("appkey"), jSONObject.getLong(n.ax)));
            ...
            if (str2.equals(HttpMethods.GET)) {
                ...
                httpGet = getNewHttpPost(new StringBuilder(String.valueOf(str)).append("?").append("source=").append(mAppkey).toString(), jSONObject);
    ...
    private static synchronized HttpPost getNewHttpPost(String str, JSONObject jSONObject) {
        ...
        synchronized (LogReport.class) {
            ...
            httpPost.setHeader(d.ck, "Keep-Alive");
            httpPost.addHeader(AsyncHttpClient.HEADER_CONTENT_ENCODING, StatisticConfig.isNeedGizp() ? AsyncHttpClient.ENCODING_GZIP : "charset=UTF-8");
