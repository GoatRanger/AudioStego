...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    static final BigInteger BI_MAX_LONG = BigInteger.valueOf(IPositioningSession.NotSet);
    ...
    protected void reportOverflowLong() throws IOException, JsonParseException {
        _reportError("Numeric value (" + getText() + ") out of range of long (" + Long.MIN_VALUE + " - " + IPositioningSession.NotSet + ")");
    }
