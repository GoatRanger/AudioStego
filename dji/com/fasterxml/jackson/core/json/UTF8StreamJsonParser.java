...
public final class UTF8StreamJsonParser extends ParserBase {
    ...
    public JsonToken nextToken() throws IOException, JsonParseException {
        ...
        if (_skipWSOrEnd == 93) {
            ...
            return jsonToken;
        } else if (_skipWSOrEnd == FTPCodes.DATA_CONNECTION_ALREADY_OPEN) {
        ...
        while (i6 < i4) {
            ...
            if (i8 > TransportMediator.KEYCODE_MEDIA_PAUSE) {
                ...
                if (i9 > 2) {
                    ...
                    int i11 = (i8 & Place.TYPE_SUBLOCALITY_LEVEL_1) | 56320;
                    i8 = i6;
                    i6 = i9;
                ...
                if (iArr[i2] != 0) {
                    ...
                    switch (iArr[i2]) {
                        ...
                        case 4:
                            ...
                            i = i2;
                            i2 = (i3 & Place.TYPE_SUBLOCALITY_LEVEL_1) | 56320;
                            break;
                        default:
                            if (i2 >= 32) {
    ...
    protected JsonToken _handleInvalidNumberStart(int i, boolean z) throws IOException, JsonParseException {
        ...
        if (i == 73) {
            ...
            } else if (i == FTPCodes.RESTART_MARKER) {
    ...
    protected void _matchToken(String str, int i) throws IOException, JsonParseException {
        ...
        if (this._inputPtr < this._inputEnd || loadMore()) {
            ...
            if (length >= 48 && length != 93 && length != FTPCodes.DATA_CONNECTION_ALREADY_OPEN && Character.isJavaIdentifierPart((char) _decodeCharForError(length))) {
                this._inputPtr++;
                _reportInvalidToken(str.substring(0, i), "'null', 'true', 'false' or NaN");
            }
        }
