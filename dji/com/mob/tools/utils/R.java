...
public class R {
    ...
    public static int dipToPx(Context context, int i) {
        ...
        return (int) ((((float) i) * density) + d.c);
    }
    ...
    public static int designToDevice(Context context, int i, int i2) {
        ...
        return (int) (((((float) i2) * ((float) deviceWidth)) / ((float) i)) + d.c);
    }
    ...
    public static int designToDevice(Context context, float f, int i) {
        ...
        return (int) (((((float) i) * density) / f) + d.c);
    }
    ...
    public static int getStyleRes(Context context, String str) {
        return getResId(context, a.L, str);
    }
    ...
    public static String getCachePath(Context context, String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            str2 = str2 + str + dji.pilot.usercenter.protocol.d.t;
        }
