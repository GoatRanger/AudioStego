...
public class BitmapHelper {
    ...
    public static String downloadBitmap(Context context, final String str) throws Throwable {
        final String cachePath = R.getCachePath(context, "images");
    ...
    private static String getFileName(HttpConnection httpConnection, String str) throws Throwable {
        ...
        if (headerFields != null) {
            ...
            if (list != null && list.size() > 0) {
                str2 = null;
                for (String str3 : ((String) list.get(0)).split(i.b)) {
                ...
                MD5 = Data.MD5(str);
                if (headerFields != null) {
                    list = (List) headerFields.get(AsyncHttpClient.HEADER_CONTENT_TYPE);
                    if (list != null && list.size() > 0) {
    ...
    public static String saveViewToImage(View view, int i, int i2) throws Throwable {
        ...
        File file = new File(R.getCachePath(view.getContext(), "screenshot"), String.valueOf(System.currentTimeMillis()) + a.n);
        OutputStream fileOutputStream = new FileOutputStream(file);
    ...
    public static Bitmap blur(Bitmap bitmap, int i, int i2) {
        int i3 = (int) ((((float) i) / ((float) i2)) + d.c);
        Bitmap createBitmap = Bitmap.createBitmap((int) ((((float) bitmap.getWidth()) / ((float) i2)) + d.c), (int) ((((float) bitmap.getHeight()) / ((float) i2)) + d.c), Config.ARGB_8888);
    ...
    public static int[] fixRect(int[] iArr, int[] iArr2) {
        ...
        if (((float) iArr[0]) / ((float) iArr[1]) > ((float) iArr2[0]) / ((float) iArr2[1])) {
            iArr3[0] = iArr2[0];
            iArr3[1] = (int) (((((float) iArr[1]) * ((float) iArr2[0])) / ((float) iArr[0])) + d.c);
        } else {
            iArr3[1] = iArr2[1];
            iArr3[0] = (int) (((((float) iArr[0]) * ((float) iArr2[1])) / ((float) iArr[1])) + d.c);
        }
        return iArr3;
    }
    ...
    public static String saveBitmap(Context context, Bitmap bitmap, CompressFormat compressFormat, int i) throws Throwable {
        String cachePath = R.getCachePath(context, "images");
        String str = a.n;
    ...
    private static String getMime(byte[] bArr) {
        byte[] bArr2 = new byte[]{(byte) -1, Code.FIXEXT16, (byte) -1, (byte) -31};
        if (bytesStartWith(bArr, new byte[]{(byte) -1, Code.FIXEXT16, (byte) -1, Code.NEGFIXINT_PREFIX}) || bytesStartWith(bArr, bArr2)) {
            return "jpg";
        }
        if (bytesStartWith(bArr, new byte[]{(byte) -119, b.a.eZ_, (byte) 78, (byte) 71})) {
            return "png";
        }
    ...
    public static int mixAlpha(int i, int i2) {
        int i3 = i >>> 24;
        return ((((255 - i3) * (i2 & 255)) + (i3 * (i & 255))) / 255) | ((((((((16711680 & i) >>> 16) * i3) + (((16711680 & i2) >>> 16) * (255 - i3))) / 255) << 16) | -16777216) | ((((((MotionEventCompat.ACTION_POINTER_INDEX_MASK & i) >>> 8) * i3) + ((255 - i3) * ((MotionEventCompat.ACTION_POINTER_INDEX_MASK & i2) >>> 8))) / 255) << 8));
    }
