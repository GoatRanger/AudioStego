...
public class NetworkHelper {
        ...
        if (responseCode == 200) {
            ...
            if (headerFields != null) {
                ...
                if (list != null && list.size() > 0) {
                    str3 = null;
                    for (String str4 : ((String) list.get(0)).split(i.b)) {
    ...
    public String jsonPost(String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) throws Throwable {
        ...
        connection.setRequestProperty(d.d, RequestParams.APPLICATION_JSON);
        if (arrayList2 != null) {
            Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
                KVPair kVPair = (KVPair) it.next();
        ...
        int responseCode = connection.getResponseCode();
        String readLine;
        if (responseCode == 200 || responseCode == dji.pilot.usercenter.f.d.y) {
            StringBuilder stringBuilder = new StringBuilder();
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(connection.getInputStream(), Charset.forName("utf-8")));
    ...
    private HTTPPart getFilePostHTTPPart(HttpURLConnection httpURLConnection, String str, ArrayList<KVPair<String>> arrayList, ArrayList<KVPair<String>> arrayList2) throws Throwable {
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                KVPair kVPair = (KVPair) it.next();
                stringPart2.append("--").append(uuid).append(DebugFile.EOL);
                stringPart2.append("Content-Disposition: form-data; name=\"").append(kVPair.name).append("\"\r\n\r\n");
                stringPart2.append((String) kVPair.value).append(DebugFile.EOL);
            }
        }
        ...
        while (it.hasNext()) {
            ...
            stringPart3.append("--").append(uuid).append(DebugFile.EOL);
            ...
            stringPart.append(DebugFile.EOL);
    ...
    public String httpPut(String str, ArrayList<KVPair<String>> arrayList, KVPair<String> kVPair, ArrayList<KVPair<String>> arrayList2, NetworkTimeOut networkTimeOut) throws Throwable {
        ...
        connection.setRequestProperty(AsyncHttpClient.HEADER_CONTENT_TYPE, RequestParams.APPLICATION_OCTET_STREAM);
        if (arrayList2 != null) {
            Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
