...
public class c extends SSDKHandlerThread {
    ...
    private void b(int i, String str, String str2) throws Throwable {
        ...
        arrayList.add(new KVPair(d.M, str2));
        arrayList.add(new KVPair(af.o, str));
        ...
        try {
            ...
            MobLog.getInstance().i("get server config == %s", this.f.httpPost(b(), arrayList, null, null, networkTimeOut));
            ...
            if (obj != null && (obj instanceof HashMap)) {
                ...
                if (fromJson.containsKey(dji.pilot.usercenter.protocol.c.ad)) {
                    this.g.a(System.currentTimeMillis() - R.parseLong(String.valueOf(fromJson.get(dji.pilot.usercenter.protocol.c.ad))));
                }
                if ("1".equals(String.valueOf(fromJson.get(c$i.a)))) {
                    this.g.a(true);
                } else {
                    this.g.a(false);
                }
    ...
    private HashMap<String, Object> c(int i, String str, String str2) throws Throwable {
        ...
        hashMap.put(n.E, this.e.getModel());
