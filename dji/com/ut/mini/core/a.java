...
public class a {
        ...
        if (hashMap != null) {
            ...
            try {
                ...
                try {
                    ...
                    if (n.a((String) networkOperatorName)) {
    ...
    private static boolean b() {
        if (n.a(a("ro.yunos.product.chip")) && n.a(a("ro.yunos.hardware"))) {
            return false;
        }
        return true;
    }
    ...
    private static String c() {
        String a = com.ut.mini.d.a.a("ro.aliyun.clouduuid", h.e);
        if (h.e.equals(a)) {
            a = com.ut.mini.d.a.a("ro.sys.aliyun.clouduuid", h.e);
        }
        if (n.a(a)) {
            return d();
        }
