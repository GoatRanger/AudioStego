...
public class AMapLocation extends Location {
    ...
    public String toStr(int i) {
        ...
        try {
            ...
            switch (i) {
                case 1:
                    ...
                    jSONObject.put(DJIMultiMomentFineActivity.U, (double) getSpeed());
                ...
                case 2:
                    jSONObject.put(n.ax, getTime());
                    break;
                case 3:
                    break;
            }
        } catch (Throwable th) {
            bc.a(th, "AMapLocation", "toStr part2");
            jSONObject2 = null;
        }
        ...
        jSONObject.put(n.n, getProvider());
