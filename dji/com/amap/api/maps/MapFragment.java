...
public class MapFragment extends Fragment {
    ...
    protected IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.b == null) {
            try {
                this.b = (IMapFragmentDelegate) fe.a(getActivity(), dj.e(), "com.amap.api.mapcore.wrapper.MapFragmentDelegateWrapper", ab.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(ab.c)});
            } catch (dk e) {
                e.printStackTrace();
                this.b = new ab(ab.c);
            }
