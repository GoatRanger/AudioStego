...
import com.amap.api.mapcore.util.y.a;
...
public final class BitmapDescriptorFactory {
    ...
    public static BitmapDescriptor defaultMarker(float f) {
        try {
            float f2;
            float f3 = (float) ((((int) (DJIFlightControllerDataType.DJIVirtualStickRollPitchControlMaxVelocity + f)) / 30) * 30);
            if (f3 > 330.0f) {
                f2 = 330.0f;
            } else if (f3 < 0.0f) {
                f2 = 0.0f;
