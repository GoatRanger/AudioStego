...
public final class VisibleRegion implements Parcelable {
    ...
    public int hashCode() {
        return dj.a(new Object[]{this.nearLeft, this.nearRight, this.farLeft, this.farRight, this.latLngBounds});
    }
    ...
    public String toString() {
        return dj.a(dj.a("nearLeft", this.nearLeft), dj.a("nearRight", this.nearRight), dj.a("farLeft", this.farLeft), dj.a("farRight", this.farRight), dj.a("latLngBounds", this.latLngBounds));
    }
}
