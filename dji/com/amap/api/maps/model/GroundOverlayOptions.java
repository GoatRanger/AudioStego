...
public final class GroundOverlayOptions implements Parcelable {
    ...
    public GroundOverlayOptions position(LatLng latLng, float f) {
        ...
        cu.a(z, (Object) "Position has already been set using positionFromBounds");
        if (latLng != null) {
            z = true;
        } else {
            z = false;
        }
        cu.b(z, "Location must be specified");
        if (f < 0.0f) {
            z2 = false;
        }
        cu.b(z2, "Width must be non-negative");
        return a(latLng, f, f);
    }
    ...
    public GroundOverlayOptions position(LatLng latLng, float f, float f2) {
        ...
        cu.b(z, "Width must be non-negative");
        if (f2 < 0.0f) {
            z2 = false;
        }
        cu.b(z2, "Height must be non-negative");
    ...
    public GroundOverlayOptions positionFromBounds(LatLngBounds latLngBounds) {
        cu.a(this.c == null, "Position has already been set using position: " + this.c);
        this.f = latLngBounds;
        return this;
    }
