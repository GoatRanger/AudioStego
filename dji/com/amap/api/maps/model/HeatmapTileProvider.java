...
public class HeatmapTileProvider implements TileProvider {
    ...
    private static final int[] a = new int[]{Color.rgb(102, FTPCodes.DATA_CONNECTION_OPEN, 0), Color.rgb(255, 0, 0)};
    ...
    public Tile getTile(int i, int i2, int i3) {
        ...
        Collection a;
        if (d4 < 0.0d) {
            a = this.c.a(new cy(1.0d + d4, 1.0d, d6, d7));
            d = Map.MOVE_PRESERVE_ZOOM_LEVEL;
        } else if (d5 > 1.0d) {
            a = this.c.a(new cy(0.0d, d5 - 1.0d, d6, d7));
            d = 1.0d;
        } else {
        ...
        if (!cyVar.a(new cy(this.e.a - d2, this.e.c + d2, this.e.b - d2, d2 + this.e.d))) {
            return TileProvider.NO_TILE;
        }
        Collection<WeightedLatLng> a2 = this.c.a(cyVar);
        if (a2.isEmpty()) {
            return TileProvider.NO_TILE;
        }
    ...
    static cy a(Collection<WeightedLatLng> collection) {
    ...
    static double a(Collection<WeightedLatLng> collection, cy cyVar, int i, int i2) {
        double d = cyVar.a;
        double d2 = cyVar.c;
        double d3 = cyVar.b;
        double d4 = cyVar.d;
