...
public class MapView extends FrameLayout {
    ...
    protected IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.a == null) {
            try {
                this.a = (IMapFragmentDelegate) fe.a(getContext(), dj.e(), "com.amap.api.mapcore.wrapper.MapFragmentDelegateWrapper", ab.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(ab.c)});
            } catch (dk e) {
                e.printStackTrace();
            }
            if (this.a == null) {
