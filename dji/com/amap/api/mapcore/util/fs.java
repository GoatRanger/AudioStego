...
public class fs {
    ...
    void a(java.lang.String r11, java.util.Map<java.lang.String, java.lang.String> r12, java.util.Map<java.lang.String, java.lang.String> r13, com.amap.api.mapcore.util.fr.a r14) {
        /*
        r10 = this;
        r1 = 0;
        r0 = 1;
    ...
    L_0x0014:
        ...
        com.amap.api.mapcore.util.eb.a(r0, r2, r3);
        goto L_0x000e;
    L_0x0020:
        r0 = move-exception;
        r0.printStackTrace();
    ...
    L_0x0130:
        r14.d();	 Catch:{ Throwable -> 0x00ed, all -> 0x0120 }
    L_0x0133:
    ...
    L_0x013f:
        ...
        goto L_0x0013;
    L_0x014c:
        r14.e();	 Catch:{ Throwable -> 0x00ed, all -> 0x0120 }
        goto L_0x0133;
    L_0x0150:
        r0 = move-exception;
        r0.printStackTrace();
        r1 = "HttpUrlUtil";
        r3 = "makeDownloadGetRequest";
        com.amap.api.mapcore.util.eb.a(r0, r1, r3);
        goto L_0x0138;
    L_0x015c:
        r0 = move-exception;
        r0.printStackTrace();
    ...
    L_0x0181:
        ...
        com.amap.api.mapcore.util.eb.a(r1, r3, r4);
        goto L_0x0126;
    L_0x018d:
        r1 = move-exception;
        r1.printStackTrace();
    ...
    L_0x0199:
        ...
        r2 = "HttpUrlUtil";
        r3 = "makeDownloadGetRequest";
        com.amap.api.mapcore.util.eb.a(r1, r2, r3);
        goto L_0x012b;
    L_0x01a5:
        r0 = move-exception;
        r2 = r1;
    ...
    fy a(String str, Map<String, String> map, Map<String, String> map2) throws dk {
        try {
            String a = a((Map) map2);
            ...
            throw new dk(AMapException.ERROR_CONNECTION);
        } catch (MalformedURLException e2) {
            throw new dk(AMapException.ERROR_URL);
        } catch (UnknownHostException e3) {
            throw new dk(AMapException.ERROR_UNKNOW_HOST);
        } catch (SocketException e4) {
            throw new dk(AMapException.ERROR_SOCKET);
        } catch (SocketTimeoutException e5) {
            throw new dk(AMapException.ERROR_SOCKE_TIME_OUT);
        } catch (IOException e6) {
            throw new dk(AMapException.ERROR_IO);
        } catch (Throwable th) {
            th.printStackTrace();
            dk dkVar = new dk(AMapException.ERROR_UNKNOWN);
        }
    }

    fy a(String str, Map<String, String> map, byte[] bArr) throws dk {
        try {
            ...
            eb.a(th, "HttpUrlUtil", "makePostReqeust");
            dk dkVar = new dk(AMapException.ERROR_UNKNOWN);
        }
    }
    ...
    private fy a(HttpURLConnection httpURLConnection) throws dk, IOException {
        ...
        try {
                ...
                try {
                    ...
                    if (byteArrayOutputStream != null) {
                        try {
                            ...
                            eb.a(th4, "HttpUrlUtil", "parseResult");
                        }
                    }
                    if (inputStream != null) {
                        try {
                            ...
                            eb.a(th5, "HttpUrlUtil", "parseResult");
                        }
                    }
                    if (pushbackInputStream2 != null) {
                        try {
                            ...
                            eb.a(th6, "HttpUrlUtil", "parseResult");
                        }
                    }
                    if (pushbackInputStream != null) {
                        try {
                            ...
                            eb.a(th62, "HttpUrlUtil", "parseResult");
                        }
                    }
                    if (httpURLConnection != null) {
                        try {
                            ...
                            eb.a(th622, "HttpUrlUtil", "parseResult");
                        }
                    }
                    throw th;
                }
            ...
            try {
                ...
                fy fyVar = new fy();
                fyVar.a = byteArrayOutputStream.toByteArray();
                fyVar.b = headerFields;
                if (byteArrayOutputStream != null) {
                    try {
                        byteArrayOutputStream.close();
                    } catch (Throwable th42) {
                        eb.a(th42, "HttpUrlUtil", "parseResult");
                    }
                }
                if (inputStream != null) {
                    try {
                        ...
                        eb.a(th52, "HttpUrlUtil", "parseResult");
                    }
                }
                if (pushbackInputStream != null) {
                    try {
                        ...
                        eb.a(th9, "HttpUrlUtil", "parseResult");
                    }
                }
                if (gZIPInputStream != null) {
                    try {
                        ...
                        eb.a(th6222, "HttpUrlUtil", "parseResult");
                    }
                }
                if (httpURLConnection != null) {
                    try {
                        ...
                        eb.a(th62222, "HttpUrlUtil", "parseResult");
                    }
                }
                return fyVar;
    ...
    private void a(Map<String, String> map, HttpURLConnection httpURLConnection) {
        ...
        try {
            ...
            eb.a(th, "HttpUrlUtil", "addHeaders");
        }
