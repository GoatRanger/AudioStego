...
public class cr {
    ...
    public static DPoint a(Context context, DPoint dPoint) {
        ...
        String a = db.a(context, "libwgs2gcj.so");
        if (!(TextUtils.isEmpty(a) || !new File(a).exists() || b)) {
            try {
                System.load(a);
                b = true;
            } catch (Throwable th) {
                bc.a(th, "OffsetUtil", ParamKey.OFFSET);
            }
        }
        return a(dPoint, b);
    }
    ...
    private static DPoint a(DPoint dPoint, boolean z) {
        double[] dArr;
        try {
            if (!bc.a(dPoint.getLatitude(), dPoint.getLongitude())) {
                return dPoint;
            }
            double[] dArr2;
            dArr = new double[2];
            if (z) {
                ...
                dArr2 = bs.a(dPoint.getLongitude(), dPoint.getLatitude());
            }
            return new DPoint(dArr2[1], dArr2[0]);
        } catch (Throwable th) {
            bc.a(th, "OffsetUtil", "cover part2");
            return dPoint;
        }
    }
