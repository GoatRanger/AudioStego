...
public class f {
    private static Map<Class<? extends e>, e> d = new HashMap();
    private k a;
    ...
    public f(Context context, e eVar) {
        try {
            this.a = new k(context.getApplicationContext(), eVar.a(), null, eVar.b(), eVar);
        } catch (Throwable th) {
            th.printStackTrace();
        }
        this.c = eVar;
    ...
    private ContentValues a(Object obj, g gVar) {
    ...
    private SQLiteDatabase a(boolean z) {
        try {
            ...
            if (z) {
                ...
                dg.a(th, "DBOperation", "getReadAbleDataBase");
            }
        }
        return this.b;
    }
    ...
    private <T> T a(Cursor cursor, Class<T> cls, g gVar) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        Field[] a = a((Class) cls, gVar.b());
    ...
    private SQLiteDatabase b(boolean z) {
        try {
            ...
            dg.a(th, "DBOperation", "getWriteDatabase");
        }
        return this.b;
    }

    private <T> g b(Class<T> cls) {
        Annotation annotation = cls.getAnnotation(g.class);
        return !a(annotation) ? null : (g) annotation;
    }
    ...
    L_0x0065:
        r2 = "DataBase";
        r3 = "searchListData";
        com.e.dg.a(r0, r2, r3);	 Catch:{ all -> 0x0103 }
    L_0x006c:
    ...
    L_0x009a:
        r2 = "DataBase";
        r3 = "searchListData";
        com.e.dg.a(r1, r2, r3);	 Catch:{ all -> 0x0094 }
        goto L_0x0087;
    L_0x00a2:
        r1 = move-exception;
    ...
    L_0x00b0:
        r1 = "DataBase";
        r2 = "searchListData";
        com.e.dg.a(r0, r1, r2);	 Catch:{ all -> 0x0094 }
        goto L_0x0071;
    L_0x00b8:
        r0 = move-exception;
    ...
    L_0x0106:
        ...
        goto L_0x0063;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.e.f.a(java.lang.String, java.lang.Class, boolean):java.util.List<T>");
    }
