...
public class dd {
    ...
    public static byte[] a() {
        ...
        try {
            ...
            split = new StringBuffer(new String(cy.b(new String(bArr)))).reverse().toString().split(",");
    ...
    public static String c(String str) {
        return str.length() < 2 ? "" : cy.a(str.substring(1));
    }
