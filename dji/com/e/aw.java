...
public class aw {
    ...
    private static final String a(String str, String str2) {
        ...
        if (!(((String) ((Hashtable) a.a.get(str2)).get(obj)).indexOf(charAt) == -1 || TextUtils.isEmpty(toLowerCase))) {
            toLowerCase = a(toLowerCase, str2);
        }
        return toLowerCase + a[((String) ((Hashtable) b.a.get(str2)).get(obj)).indexOf(charAt)];
    }
