...
public class AuthActivity extends Activity {
                ...
                try {
                    ...
                    if (a2 == null || TextUtils.equals(a2, com.alipay.sdk.b.a.g)) {
                        if (str.startsWith("intent://platformapi/startapp")) {
                            str = str.replaceFirst(com.alipay.sdk.b.a.i, com.alipay.sdk.b.a.h);
                        }
    ...
    static /* synthetic */ void a(AuthActivity authActivity, com.alipay.sdk.a.a aVar) {
        if (authActivity.c != null && aVar != null) {
            try {
                ...
                jSONObject.put(com.alipay.sdk.a.a.e, aVar.i);
                jSONObject.put(com.alipay.sdk.a.a.g, aVar.k);
                jSONObject.put(com.alipay.sdk.a.a.f, aVar.m);
                jSONObject.put(com.alipay.sdk.a.a.h, aVar.l);
    ...
    static /* synthetic */ void b(AuthActivity authActivity, String str) {
        String str2;
        com.alipay.sdk.a.c cVar = new com.alipay.sdk.a.c(authActivity.getApplicationContext(), new d(authActivity));
        try {
            JSONObject jSONObject = new JSONObject(str);
            String string = jSONObject.getString(com.alipay.sdk.a.a.e);
            try {
                if (!TextUtils.isEmpty(string)) {
                    JSONObject jSONObject2 = jSONObject.getJSONObject(com.alipay.sdk.a.a.f);
                    jSONObject2 = jSONObject2 instanceof JSONObject ? jSONObject2 : null;
                    String string2 = jSONObject.getString(com.alipay.sdk.a.a.g);
                    String string3 = jSONObject.getString(com.alipay.sdk.a.a.d);
                ...
                if (!TextUtils.isEmpty(str2)) {
                    try {
                        cVar.a(str2, com.alipay.sdk.a.a.a.d);
    ...
    static /* synthetic */ void d(AuthActivity authActivity) {
        try {
            if (authActivity.e == null) {
                authActivity.e = new com.alipay.sdk.k.a(authActivity, com.alipay.sdk.k.a.a);
            }
            authActivity.e.a();
        } catch (Exception e) {
            authActivity.e = null;
        ...
        try {
            ...
            try {
                ...
                if (l.b(string)) {
                    ...
                    settings.setUserAgentString(settings.getUserAgentString() + l.c(getApplicationContext()));
    ...
    public void onBackPressed() {
        if (!this.c.canGoBack()) {
            j.a((Activity) this, this.d + "?resultCode=150");
            finish();
        } else if (this.h) {
            j.a((Activity) this, this.d + "?resultCode=150");
            finish();
    ...
    private void b(String str) {
        String str2;
        com.alipay.sdk.a.c cVar = new com.alipay.sdk.a.c(getApplicationContext(), new d(this));
        try {
            JSONObject jSONObject = new JSONObject(str);
            String string = jSONObject.getString(com.alipay.sdk.a.a.e);
            try {
    ...
    private void a(com.alipay.sdk.a.a aVar) {
        if (this.c != null && aVar != null) {
            try {
                ...
                jSONObject.put(com.alipay.sdk.a.a.f, aVar.m);
                jSONObject.put(com.alipay.sdk.a.a.h, aVar.l);
                runOnUiThread(new e(this, String.format("AlipayJSBridge._invokeJS(%s)", new Object[]{jSONObject.toString()})));
            } catch (JSONException e) {
            }
        }
    }
    ...
    private void a() {
        try {
            if (this.e == null) {
                this.e = new com.alipay.sdk.k.a(this, com.alipay.sdk.k.a.a);
            }
            this.e.a();
        } catch (Exception e) {
            this.e = null;
