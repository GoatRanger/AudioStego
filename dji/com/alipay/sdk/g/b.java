...
public final class b {
    ...
    private static void a(b bVar) {
        ...
        if (strArr.length == 3 && TextUtils.equals(com.alipay.sdk.b.b.c, strArr[0])) {
            Context context = com.alipay.sdk.h.b.a().a;
            com.alipay.sdk.i.b a = com.alipay.sdk.i.b.a();
            if (!TextUtils.isEmpty(strArr[1]) && !TextUtils.isEmpty(strArr[2])) {
                a.a = strArr[1];
                a.b = strArr[2];
                a aVar = new a(context);
                try {
                    aVar.a(com.alipay.sdk.j.b.a(context).a(), com.alipay.sdk.j.b.a(context).b(), a.a, a.b);
                } catch (Exception e) {
                } finally {
                    aVar.close();
                }
