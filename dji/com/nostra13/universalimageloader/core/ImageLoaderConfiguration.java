...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        public Builder discCacheExtraOptions(int i, int i2, CompressFormat compressFormat, int i3, BitmapProcessor bitmapProcessor) {
        ...
        public Builder memoryCacheSizePercentage(int i) {
            ...
            this.memoryCacheSize = (int) (((float) Runtime.getRuntime().maxMemory()) * (((float) i) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity));
            return this;
        }
