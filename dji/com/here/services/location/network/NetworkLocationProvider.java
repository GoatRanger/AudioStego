...
public class NetworkLocationProvider implements NetworkLocationApi {
    ...
    public NetworkLocationProvider(Context context, Provider<LocationServicesController> provider) {
