...
import com.here.services.location.highaccuracy.HighAccuracyLocationApi.Options;
...
public class HighAccuracyLocationProvider implements HighAccuracyLocationApi {
    ...
    public HighAccuracyLocationProvider(Context context, Provider<LocationServicesController> provider) {
        if (provider == null) {
