...
public interface ILocationServiceController extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILocationServiceController {
        private static final String DESCRIPTOR = "com.here.services.internal.ILocationServiceController";
        static final int TRANSACTION_updateOptions = 1;

        private static class Proxy implements ILocationServiceController {
        ...
        public static ILocationServiceController asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationServiceController)) {
                return new Proxy(iBinder);
            }
            return (ILocationServiceController) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    boolean updateOptions = updateOptions(bundle);
