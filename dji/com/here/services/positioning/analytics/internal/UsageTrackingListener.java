...
public interface UsageTrackingListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements UsageTrackingListener {
        private static final String DESCRIPTOR = "com.here.services.positioning.analytics.internal.UsageTrackingListener";
        static final int TRANSACTION_onTrackerUpdated = 1;

        private static class Proxy implements UsageTrackingListener {
        ...
        public static UsageTrackingListener asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof UsageTrackingListener)) {
                return new Proxy(iBinder);
            }
            return (UsageTrackingListener) queryLocalInterface;
        }
