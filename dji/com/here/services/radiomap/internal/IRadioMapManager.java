...
public interface IRadioMapManager extends Manager {
    ...
    boolean startRadioMapQuery(List<GeoArea> list, int i, RadioMapQueryAction radioMapQueryAction, IRadioMapActionListener iRadioMapActionListener);

    boolean startRadioMapUpdate(List<GeoArea> list, int i, RadioMapStorageAction radioMapStorageAction, IRadioMapActionListener iRadioMapActionListener);
