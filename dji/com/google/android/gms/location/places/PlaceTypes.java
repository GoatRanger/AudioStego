...
public class PlaceTypes {
    ...
    public static final Set<Integer> zzaGx = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Integer[]{Integer.valueOf(1001), Integer.valueOf(1002), Integer.valueOf(1003), Integer.valueOf(1005), Integer.valueOf(1006), Integer.valueOf(1009), Integer.valueOf(1014), Integer.valueOf(1015), Integer.valueOf(1016), Integer.valueOf(1017), Integer.valueOf(1018), Integer.valueOf(1019), Integer.valueOf(1020), Integer.valueOf(1021), Integer.valueOf(Place.TYPE_SUBLOCALITY), Integer.valueOf(Place.TYPE_SUBLOCALITY_LEVEL_1), Integer.valueOf(1024), Integer.valueOf(1025), Integer.valueOf(Place.TYPE_SUBLOCALITY_LEVEL_4), Integer.valueOf(Place.TYPE_SUBLOCALITY_LEVEL_5), Integer.valueOf(Place.TYPE_SUBPREMISE)})));
    public static final Set<Integer> zzaGy = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Integer[]{Integer.valueOf(1001), Integer.valueOf(1002), Integer.valueOf(1003), Integer.valueOf(1005), Integer.valueOf(1009), Integer.valueOf(1015), Integer.valueOf(1016), Integer.valueOf(1017)})));

    static {
        Integer[] numArr = new Integer[FTPCodes.DATA_CONNECTION_ALREADY_OPEN];
        ...
        numArr[FTPCodes.RESTART_MARKER] = Integer.valueOf(1015);
        numArr[TrackerEvent.PositioningOnlineOutdoor] = Integer.valueOf(1016);
        numArr[d.k] = Integer.valueOf(1017);
        numArr[113] = Integer.valueOf(1018);
        numArr[114] = Integer.valueOf(1019);
        numArr[115] = Integer.valueOf(1020);
        numArr[116] = Integer.valueOf(1021);
        numArr[117] = Integer.valueOf(Place.TYPE_SUBLOCALITY);
        numArr[118] = Integer.valueOf(Place.TYPE_SUBLOCALITY_LEVEL_1);
        numArr[119] = Integer.valueOf(1024);
        numArr[120] = Integer.valueOf(1025);
        numArr[TrackerEvent.PositioningHybridOutdoor] = Integer.valueOf(Place.TYPE_SUBLOCALITY_LEVEL_4);
