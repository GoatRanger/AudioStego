...
public class PlacesParams implements SafeParcelable {
    ...
    public String toString() {
        return zzw.zzv(this).zzg("clientPackageName", this.zzaHR).zzg(a.k, this.zzaHS).zzg("accountName", this.zzaHT).zzg("gCoreClientName", this.zzaGG).zzg("chargedPackageName", this.zzaHU).toString();
    }
