...
public class StreetViewPanoramaCamera implements SafeParcelable {
    ...
    StreetViewPanoramaCamera(int i, float f, float f2, float f3) {
        ...
        zzx.zzb(z, "Tilt needs to be between -90 and 90 inclusive");
        this.mVersionCode = i;
        if (((double) f) <= 0.0d) {
            f = 0.0f;
        }
        ...
        this.zzaKy = new com.google.android.gms.maps.model.StreetViewPanoramaOrientation.Builder().tilt(f2).bearing(f3).build();
    }
