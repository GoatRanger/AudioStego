...
public interface zza extends IInterface {
    ...
    public static abstract class zza extends Binder implements zza {
        ...
        private static class zza implements zza {
            ...
            public zzd zzdE(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
            ...
            public zzd zzhV(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
            ...
            public zzd zzyc() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    zzhV = zzhV(parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zzhV != null ? zzhV.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    zzhV = zzdE(parcel.readString());
                    parcel2.writeNoException();
                    if (zzhV != null) {
                        iBinder = zzhV.asBinder();
                    }
                    parcel2.writeStrongBinder(iBinder);
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    zzhV = zzdF(parcel.readString());
                    parcel2.writeNoException();
                    if (zzhV != null) {
                        iBinder = zzhV.asBinder();
                    }
                ...
                case 6:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    zzhV = zzb(parcel.readInt() != 0 ? (Bitmap) Bitmap.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (zzhV != null) {
                        iBinder = zzhV.asBinder();
                    }
    ...
    zzd zzdE(String str) throws RemoteException;
    ...
    zzd zzhV(int i) throws RemoteException;

    zzd zzyc() throws RemoteException;
}
