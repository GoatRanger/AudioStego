...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaDelegate {
        ...
        private static class zza implements IStreetViewPanoramaDelegate {
            ...
            public StreetViewPanoramaCamera getPanoramaCamera() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    StreetViewPanoramaCamera zzfq = obtain2.readInt() != 0 ? StreetViewPanoramaCamera.CREATOR.zzfq(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzfq;
                } catch (Throwable th) {
            ...
            public StreetViewPanoramaLocation getStreetViewPanoramaLocation() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    StreetViewPanoramaLocation zzfs = obtain2.readInt() != 0 ? StreetViewPanoramaLocation.CREATOR.zzfs(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzfs;
                } catch (Throwable th) {
            ...
            public StreetViewPanoramaOrientation pointToOrientation(zzd com_google_android_gms_dynamic_zzd) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        streetViewPanoramaOrientation = StreetViewPanoramaOrientation.CREATOR.zzft(obtain2);
                    }
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static IStreetViewPanoramaDelegate zzcL(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 9:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    animateTo(parcel.readInt() != 0 ? StreetViewPanoramaCamera.CREATOR.zzfq(parcel) : null, parcel.readLong());
                    parcel2.writeNoException();
                    return true;
                case 10:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                ...
                case 13:
                    ...
                    setPositionWithRadius(zzfl, parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 14:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                ...
                case 15:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaChangeListener(com.google.android.gms.maps.internal.zzs.zza.zzcF(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 16:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaCameraChangeListener(com.google.android.gms.maps.internal.zzr.zza.zzcE(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 17:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaClickListener(com.google.android.gms.maps.internal.zzt.zza.zzcG(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 18:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                ...
                case 19:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    zzd orientationToPoint = orientationToPoint(parcel.readInt() != 0 ? StreetViewPanoramaOrientation.CREATOR.zzft(parcel) : null);
                    parcel2.writeNoException();
                ...
                case 20:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaLongClickListener(com.google.android.gms.maps.internal.zzu.zza.zzcH(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
