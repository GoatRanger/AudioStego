...
public final class GooglePlayServicesUtil {
    ...
    private static void zza(int i, Context context, String str) {
        ...
        if (zzml.zzan(context)) {
            zzx.zzZ(zzmx.zzqy());
            build = new Notification.Builder(context).setSmallIcon(R.drawable.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new BigTextStyle().bigText(zzi + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + zzd)).addAction(R.drawable.common_full_open_on_phone, resources.getString(R.string.common_open_on_phone), zza).build();
        } else {
    ...
    private static void zzae(Context context) {
        ...
        com_google_android_gms_common_GooglePlayServicesUtil_zza.sendMessageDelayed(com_google_android_gms_common_GooglePlayServicesUtil_zza.obtainMessage(1), OdnpConfigStatic.OEM_MAX_HIGH_POWER_INTERVAL);
    }
    ...
    public static boolean zzd(Context context, int i) {
        return i == 18 ? true : i == 1 ? zzj(context, "com.google.android.gms") : false;
    }
