...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        private GoogleApiClient zznC() {
            final GoogleApiClient com_google_android_gms_internal_zzli = new zzli(this.mContext.getApplicationContext(), this.zzaaO, zznB(), this.zzaaP, this.zzaaQ, this.zzaaK, this.zzaaR, this.zzaaS, this.zzaaM);
                ...
                new Handler(this.mContext.getMainLooper()).post(new Runnable(this) {
                    ...
                    public void run() {
                        if (!this.zzaaU.zzaaL.isFinishing() && !this.zzaaU.zzaaL.getSupportFragmentManager().isDestroyed()) {
                            this.zzaaU.zza(zzlp.zzb(this.zzaaU.zzaaL), com_google_android_gms_internal_zzli);
                        }
                    }
                });
            } else {
