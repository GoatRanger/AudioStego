...
public class zzlg implements zzlj {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzb {
        ...
        public void zza(final ConnectionResult connectionResult, AuthAccountResult authAccountResult) {
            final zzlg com_google_android_gms_internal_zzlg = (zzlg) this.zzabM.get();
            if (com_google_android_gms_internal_zzlg != null) {
                com_google_android_gms_internal_zzlg.zzabr.zza(new zzb(this, com_google_android_gms_internal_zzlg) {
                    final /* synthetic */ zza zzabP;

                    public void zznO() {
                        com_google_android_gms_internal_zzlg.zzc(connectionResult);
                    }
                });
            }
        }
        ...
        public void zzb(final ResolveAccountResponse resolveAccountResponse) {
            ...
            if (com_google_android_gms_internal_zzlg != null) {
                com_google_android_gms_internal_zzlg.zzabr.zza(new zzb(this, com_google_android_gms_internal_zzlg) {
                    ...
                    public void zznO() {
                        com_google_android_gms_internal_zzlg.zza(resolveAccountResponse);
                    }
                });
            }
        }
    ...
    private class zze extends zzi {
        ...
        public void zznO() {
            ...
            if (isGooglePlayServicesAvailable != 0) {
                ...
                this.zzabL.zzabr.zza(new zzb(this, this.zzabL) {
                    final /* synthetic */ zze zzabW;

                    public void zznO() {
                        this.zzabW.zzabL.zzf(connectionResult);
                    }
                });
                return;
            }
