...
import dji.pilot2.scan.android.f.f;
...
public final class af extends u {
    ...
    private static final Pattern g = Pattern.compile(i.b);
    ...
    public d a(r rVar) {
        ...
        if (a == null) {
            ...
            strArr = i.split((CharSequence) a.get(0));
        }
        ...
        if (b3 == null || a((CharSequence) b3.get(0))) {
            list = b3;
        } else {
            list = null;
        }
        List b4 = b(n.G, c, true, false);
        Collection a5 = a("URL", c, true, false);
        List b5 = b("IMPP", c, true, false);
        a = b("GEO", c, true, false);
        String[] split = a == null ? null : j.split((CharSequence) a.get(0));
        if (!(split == null || split.length == 2)) {
            split = null;
        }
        return new d(a(collection), strArr, null, a(a2), b(a2), a(a3), b(a3), a(b5), a(b), a(a4), b(a4), a(b2), a(list), a(b4), a(a5), split);
    }
        ...
        while (i < length) {
            ...
            if (i < 0) {
                ...
                if (obj != null) {
                    ...
                    a = e.matcher(d.matcher(c.matcher(substring).replaceAll("")).replaceAll("\n")).replaceAll("$1");
                }
                if (list2 == null) {
    ...
    private static String[] b(Collection<List<String>> collection) {
        ...
        for (List list : collection) {
            ...
            while (i < list.size()) {
                ...
                if (indexOf < 0) {
                    break;
                } else if (f.c.equalsIgnoreCase(obj.substring(0, indexOf))) {
