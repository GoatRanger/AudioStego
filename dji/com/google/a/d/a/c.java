...
final class c {
    ...
    static e a(byte[] bArr) throws h {
        String stringBuilder;
        List list;
        com.google.a.c.c cVar = new com.google.a.c.c(bArr);
    ...
    private static a a(com.google.a.c.c cVar, StringBuilder stringBuilder, StringBuilder stringBuilder2) throws h {
        int i = 0;
        do {
            int a = cVar.a(8);
            if (a == 0) {
                ...
                } else if (a == FTPCodes.USER_LOGGED_IN) {
                    return a.C40_ENCODE;
                } else {
                    if (a == 231) {
    ...
    private static void a(com.google.a.c.c cVar, StringBuilder stringBuilder) throws h {
        int[] iArr = new int[3];
        int i = 0;
        Object obj = null;
        while (cVar.c() != 8) {
            ...
            if (a != 254) {
                ...
                for (a = 0; a < 3; a++) {
                    ...
                    switch (i) {
                        ...
                        case 3:
                            if (obj != null) {
                                stringBuilder.append((char) (i2 + dji.thirdparty.g.b.a.a.fw_));
                                obj = null;
                            } else {
    ...
    private static void b(com.google.a.c.c cVar, StringBuilder stringBuilder) throws h {
        int[] iArr = new int[3];
        int i = 0;
        Object obj = null;
        while (cVar.c() != 8) {
    ...
    private static void c(com.google.a.c.c cVar, StringBuilder stringBuilder) throws h {
        int[] iArr = new int[3];
        while (cVar.c() != 8) {
            int a = cVar.a(8);
            if (a != 254) {
    ...
    private static void d(com.google.a.c.c cVar, StringBuilder stringBuilder) {
        while (cVar.c() > 16) {
            for (int i = 0; i < 4; i++) {
                int a = cVar.a(6);
                if (a == 31) {
    ...
    private static void a(com.google.a.c.c cVar, StringBuilder stringBuilder, Collection<byte[]> collection) throws h {
        int c;
        int b = cVar.b() + 1;
        int i = b + 1;
        b = a(cVar.a(8), b);
