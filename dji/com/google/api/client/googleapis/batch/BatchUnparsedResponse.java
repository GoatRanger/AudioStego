...
final class BatchUnparsedResponse {
    ...
    void parseNextResponse() throws IOException {
        ...
        int parseInt = Integer.parseInt(this.bufferedReader.readLine().split(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR)[1]);
    ...
    private <T, E> void parseAndCallback(RequestInfo<T, E> requestInfo, int i, int i2, HttpResponse httpResponse) throws IOException {
        ...
        if (!HttpStatusCodes.isSuccess(i)) {
            ...
            if (unsuccessfulResponseHandler != null) {
                handleResponse = unsuccessfulResponseHandler.handleResponse(requestInfo.request, httpResponse, z2);
            } else {
