...
public class GoogleAccountCredential implements HttpRequestInitializer {
    ...
    public static GoogleAccountCredential usingAudience(Context context, String str) {
        ...
        return new GoogleAccountCredential(context, valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
    }
    ...
    L_0x0014:
        r0 = move-exception;
        r1 = r3.backOff;	 Catch:{ InterruptedException -> 0x0024 }
        if (r1 == 0) goto L_0x0023;
    L_0x0019:
        r1 = r3.sleeper;	 Catch:{ InterruptedException -> 0x0024 }
        r2 = r3.backOff;	 Catch:{ InterruptedException -> 0x0024 }
