...
public final class OAuthParameters implements HttpExecuteInterceptor, HttpRequestInitializer {
    ...
    public void computeSignature(String str, GenericUrl genericUrl) throws GeneralSecurityException {
        ...
        putParameterIfValueNotNull(treeMap, MobileRegisterActivity.RESPONSE_OAUTH_TOKEN, this.token);
        ...
        if (("http".equals(scheme) && port == 80) || (b.a.equals(scheme) && port == 443)) {
            port = -1;
        }
    ...
    public String getAuthorizationHeader() {
        ...
        appendParameter(stringBuilder, MobileRegisterActivity.RESPONSE_OAUTH_TOKEN, this.token);
