...
class WWW extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            if (!url.getProtocol().equalsIgnoreCase(d.A) || url.getHost() == null || url.getHost().length() == 0) {
                int min;
                ...
                if (openConnection instanceof HttpURLConnection) {
                    ...
                    try {
                        ...
                        if (headerFields != null && (min == HttpStatusCodes.STATUS_CODE_MOVED_PERMANENTLY || min == HttpStatusCodes.STATUS_CODE_FOUND)) {
                ...
                if ((headerFields2 == null || !headerFields2.containsKey(com.alipay.sdk.f.d.d)) && openConnection.getContentType() != null) {
                    headerCallback = headerCallback || headerCallback(com.alipay.sdk.f.d.d, openConnection.getContentType());
                }
                if (headerCallback) {
                ...
                i = (url.getProtocol().equalsIgnoreCase(d.A) || url.getProtocol().equalsIgnoreCase("jar")) ? contentLength == 0 ? 32768 : Math.min(contentLength, 32768) : 1428;
                int i3 = 0;
                try {
                    String str;
