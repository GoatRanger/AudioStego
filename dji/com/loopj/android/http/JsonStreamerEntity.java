...
public class JsonStreamerEntity implements HttpEntity {
    ...
    private static final byte[] JSON_FALSE = h.e.getBytes();
    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        ...
        for (String str : this.jsonParams.keySet()) {
            ...
            if (obj != null) {
                ...
                if (z || (obj instanceof StreamWrapper)) {
                    ...
                    outputStream.write(FTPCodes.DATA_CONNECTION_ALREADY_OPEN);
        ...
        outputStream.write((currentTimeMillis2 + i.d).getBytes());
