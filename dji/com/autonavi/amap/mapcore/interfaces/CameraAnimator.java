...
public class CameraAnimator {
    ...
    static {
        ...
        while (i < 100) {
            float f3;
            float f4 = ((float) i) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity;
            float f5 = 1.0f;
            float f6 = f2;
            while (true) {
                f2 = ((f5 - f6) / 2.0f) + f6;
        ...
        if (((long) currentAnimationTimeMillis) < this.mDuration) {
            ...
            switch (this.mMode) {
                case 1:
                    ...
                    int i = (int) (DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity * f2);
                    float f3 = 1.0f;
                    f = 0.0f;
                    if (i < 100) {
                        f3 = ((float) i) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity;
                        f = ((float) (i + 1)) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity;
