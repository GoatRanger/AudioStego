...
public class MapTilsCacheAndResManagerImpl extends MapTilsCacheAndResManager {
    ...
    private void initRelease() {
        ...
        this.mMapBaseDataPath = file2.toString() + d.t;
        file = new File(file2, MapTilsCacheAndResManager.MAP_DATA_OFFLINE_PATH_NAME);
        if (!file.exists()) {
            file.mkdir();
        }
        this.mMapOfflinePath = file.toString() + d.t;
        ...
        this.mCachePath = file3.toString() + d.t;
        ...
        this.mMapOnlineTilesPath = file4.toString() + d.t;
        ...
        this.mMapExtResPath = file2.toString() + d.t;
    }
