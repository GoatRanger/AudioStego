...
public class PullToRefreshExpandableListView extends PullToRefreshAdapterViewBase<ExpandableListView> {
    ...
    protected ExpandableListView createRefreshableView(Context context, AttributeSet attributeSet) {
        ExpandableListView internalExpandableListViewSDK9;
        if (VERSION.SDK_INT >= 9) {
            internalExpandableListViewSDK9 = new InternalExpandableListViewSDK9(context, attributeSet);
        } else {
            internalExpandableListViewSDK9 = new InternalExpandableListView(context, attributeSet);
        }
