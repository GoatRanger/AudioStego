...
public class PullToRefreshGridView extends PullToRefreshAdapterViewBase<GridView> {
    ...
    protected final GridView createRefreshableView(Context context, AttributeSet attributeSet) {
        GridView internalGridViewSDK9;
        if (VERSION.SDK_INT >= 9) {
            internalGridViewSDK9 = new InternalGridViewSDK9(context, attributeSet);
        } else {
            internalGridViewSDK9 = new InternalGridView(context, attributeSet);
        }
        internalGridViewSDK9.setId(R.id.h);
