...
public class MessageUnpacker implements Closeable {
    ...
    private MessageBuffer prepareNumberBuffer(int i) throws IOException {
        ...
        while (true) {
            ...
            if (size2 >= i) {
                this.numberBuffer.putBytes(size, this.buffer.array(), this.buffer.arrayOffset(), i);
                this.position = i;
                this.nextReadPosition = 0;
                return this.numberBuffer;
            }
            this.numberBuffer.putBytes(size, this.buffer.array(), this.buffer.arrayOffset(), size2);
            i -= size2;
            size += size2;
        }
    }
    ...
    public byte unpackByte() throws IOException {
        ...
        switch (readByte) {
            ...
            case (byte) -50:
                readInt = readInt();
                if (readInt >= 0 && readInt <= TransportMediator.KEYCODE_MEDIA_PAUSE) {
                    return (byte) readInt;
                }
            ...
            case (byte) -46:
                readInt = readInt();
                if (readInt >= -128 && readInt <= TransportMediator.KEYCODE_MEDIA_PAUSE) {
                    return (byte) readInt;
                }
    ...
    public short unpackShort() throws IOException {
        ...
        switch (readByte) {
            ...
            case (byte) -49:
                readLong = readLong();
                if (readLong >= 0 && readLong <= UpdateOptions.TECHNOLOGY_ALL) {
            ...
            case (byte) -45:
                readLong = readLong();
                if (readLong >= -32768 && readLong <= UpdateOptions.TECHNOLOGY_ALL) {
                    return (short) ((int) readLong);
                }
                throw overflowI64(readLong);
            default:
    ...
    public int unpackInt() throws IOException {
        ...
        switch (readByte) {
            ...
            case (byte) -49:
                readLong = readLong();
                if (readLong >= 0 && readLong <= UpdateOptions.SOURCE_ANY) {
                    return (int) readLong;
                }
                throw overflowU64(readLong);
            case (byte) -48:
            ...
            case (byte) -45:
                readLong = readLong();
                if (readLong >= -2147483648L && readLong <= UpdateOptions.SOURCE_ANY) {
                    return (int) readLong;
                }
                throw overflowI64(readLong);
            default:
    ...
    public BigInteger unpackBigInteger() throws IOException {
        ...
        switch (readByte) {
            ...
            case (byte) -49:
                long readLong = readLong();
                if (readLong < 0) {
                    return BigInteger.valueOf((readLong + IPositioningSession.NotSet) + 1).setBit(63);
                }
    ...
    public String unpackString() throws IOException {
        ...
        } else if (this.buffer.size() - this.position >= unpackRawStringHeader) {
    ...
    public ExtensionTypeHeader unpackExtensionTypeHeader() throws IOException {
        ...
        switch (readByte) {
            ...
            case (byte) -56:
                ...
                return new ExtensionTypeHeader(prepareNumberBuffer.getByte(this.nextReadPosition + 2), prepareNumberBuffer.getShort(this.nextReadPosition) & 65535);
            case (byte) -55:
    ...
    private static MessageIntegerOverflowException overflowU64(long j) {
        return new MessageIntegerOverflowException(BigInteger.valueOf((IPositioningSession.NotSet + j) + 1).setBit(63));
    }
