...
public class Variable implements Value {
    ...
    private static final BigInteger LONG_MAX = BigInteger.valueOf(IPositioningSession.NotSet);
    ...
    private class IntegerValueAccessor extends AbstractNumberValueAccessor implements IntegerValue {
        ...
        public boolean isInShortRange() {
            if (Variable.this.type != Type.BIG_INTEGER && Variable.SHORT_MIN <= Variable.this.longValue && Variable.this.longValue <= 32767) {
                return true;
            }
            return false;
        }
        ...
        public boolean isInIntRange() {
            if (Variable.this.type != Type.BIG_INTEGER && Variable.INT_MIN <= Variable.this.longValue && Variable.this.longValue <= 2147483647L) {
                return true;
            }
            return false;
        }
