...
public class ImmutableBigIntegerValueImpl extends AbstractImmutableValue implements ImmutableIntegerValue {
    ...
    private static final BigInteger INT_MAX = BigInteger.valueOf(UpdateOptions.SOURCE_ANY);
    ...
    private static final BigInteger SHORT_MAX = BigInteger.valueOf(UpdateOptions.TECHNOLOGY_ALL);
