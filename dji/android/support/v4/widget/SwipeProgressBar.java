    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (this.mRunning) {
                ...
                float interpolation = INTERPOLATOR.getInterpolation((((float) ((currentAnimationTimeMillis - this.mFinishTime) % 1000)) / 10.0f) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity) * f2;
            ...
            if (f >= 0.0f && f <= 25.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) i, (float) i2, this.mColor1, ((25.0f + f) * 2.0f) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity);
            }
            if (f >= 0.0f && f <= 50.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) i, (float) i2, this.mColor2, (2.0f * f) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity);
            }
            if (f >= 25.0f && f <= 75.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) i, (float) i2, this.mColor3, ((f - 25.0f) * 2.0f) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity);
            }
            if (f >= 50.0f && f <= DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) i, (float) i2, this.mColor4, ((f - 50.0f) * 2.0f) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity);
            }
            if (f >= 75.0f && f <= DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) i, (float) i2, this.mColor1, ((f - 75.0f) * 2.0f) / DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity);
            }
