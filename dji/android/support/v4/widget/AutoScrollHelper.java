...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (this.mStopTime < 0 || j < this.mStopTime) {
                return AutoScrollHelper.constrain(((float) (j - this.mStartTime)) / ((float) this.mRampUpDuration), 0.0f, 1.0f) * d.c;
            }
        ...
        private float interpolateValue(float f) {
            return ((DJIFlightControllerDataType.DJIVirtualStickVerticalControlMinVelocity * f) * f) + (DJIFlightControllerDataType.DJIVirtualStickVerticalControlMaxVelocity * f);
        }
    ...
    public AutoScrollHelper(View view) {
        ...
        int i = (int) ((1575.0f * displayMetrics.density) + d.c);
        int i2 = (int) ((displayMetrics.density * 315.0f) + d.c);
