...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    private void moveSpinner(float f) {
        ...
        abs = ((float) (((double) (abs / DJIFlightControllerDataType.DJIVirtualStickVerticalControlMaxVelocity)) - Math.pow((double) (abs / DJIFlightControllerDataType.DJIVirtualStickVerticalControlMaxVelocity), 2.0d))) * DECELERATE_INTERPOLATION_FACTOR;
