...
public class ViewPager extends ViewGroup {
    ...
    void initViewPager() {
        ...
        this.mDefaultGutterSize = (int) (b.a * f);
    ...
    float distanceInfluenceForSnapDuration(float f) {
        return (float) Math.sin((double) ((float) (((double) (f - d.c)) * 0.4712389167638204d)));
    }
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        if (abs > 0) {
            ...
            currX = (int) (((((float) Math.abs(i5)) / ((((float) currX) * this.mAdapter.getPageWidth(this.mCurItem)) + ((float) this.mPageMargin))) + 1.0f) * DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity);
        }
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    int i7 = layoutParams.gravity & dji.pilot.usercenter.protocol.d.k;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i8 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                layoutParams = (LayoutParams) childAt.getLayoutParams();
                if (layoutParams.isDecor) {
                    int i9 = layoutParams.gravity & dji.pilot.usercenter.protocol.d.k;
            ...
            case 2:
                ...
                if (action != -1) {
                    ...
                    if (f == 0.0f || isGutterDrag(this.mLastMotionX, f) || !canScroll(this, false, (int) f, (int) x2, (int) y)) {
                        if (abs > ((float) this.mTouchSlop) && d.c * abs > abs2) {
                            this.mIsBeingDragged = true;
                            requestParentDisallowInterceptTouchEvent(true);
                            setScrollState(1);
    ...
    private int determineTargetPage(int i, float f, int i2, int i3) {
        if (Math.abs(i3) <= this.mFlingDistance || Math.abs(i2) <= this.mMinimumVelocity) {
            i += (int) ((i >= this.mCurItem ? 0.4f : l.n) + f);
        } else if (i2 <= 0) {
            i++;
        }
        if (this.mItems.size() <= 0) {
