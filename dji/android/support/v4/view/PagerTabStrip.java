...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mIndicatorHeight = (int) ((3.0f * f) + d.c);
        this.mMinPaddingBottom = (int) ((6.0f * f) + d.c);
        this.mMinTextSpacing = (int) (64.0f * f);
        this.mTabPadding = (int) ((b.a * f) + d.c);
        this.mFullUnderlineHeight = (int) ((1.0f * f) + d.c);
        this.mMinStripHeight = (int) ((f * 32.0f) + d.c);
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        this.mTabAlpha = (int) ((Math.abs(f - d.c) * 2.0f) * 255.0f);
