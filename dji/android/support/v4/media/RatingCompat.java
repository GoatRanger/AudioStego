...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newStarRating(int i, float f) {
        ...
        switch (i) {
            case 3:
                ...
                break;
            case 4:
                f2 = DJIFlightControllerDataType.DJIVirtualStickVerticalControlMaxVelocity;
                break;
            case 5:
                f2 = 5.0f;
                break;
    ...
    public static RatingCompat newPercentageRating(float f) {
        if (f >= 0.0f && f <= DJIFlightControllerDataType.DJIVirtualStickYawControlMaxAngularVelocity) {
