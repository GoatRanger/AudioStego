...
public class WidePolygon extends SolidElement
    ...
    public WidePolygon(int[] x, int[] y, int numPoints, double width, int color,
        boolean isVerticesOn, boolean isShapeACircle, int widthOfShape, int colorOfShape,
        int indexRedShape) {
