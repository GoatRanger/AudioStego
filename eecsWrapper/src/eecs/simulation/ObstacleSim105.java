...
public class ObstacleSim105 extends jago.SimBox
{
  	...
  	switch (scenarioNumber){
  	 case 1:// Fire only
  	  ...
  	  obstacleSpacing=350;
  	 	...
  	 	break;
  	 case 2: // Concertina Only
  	  numOfObstacles=1;
  	  randomObstacleType[1]=1;
  	  obstacle1YLocation=150;
  	  obstacleSpacing=350;
  	 	break;
  	 case 3:  //random single obstacle
  	 	numOfObstacles=1;
  	 	//do not need to randomly assigned obstacles because setRandomObstacleArray already does this for us
  	 	obstacle1YLocation=150;
    	obstacleSpacing=350;
  	 	break;
	 case 4: //fixed double with fire first
	 	numOfObstacles=2;
	    randomObstacleType[1]=2;
	    randomObstacleType[2]=1;
	 	break;
     case 5: //random double
  	    numOfObstacles=2;
  	    //setRandomObstacle Array handles the order of obstacles.
       
        break;
     case 6://test cases obstacle do not matter
     	numOfObstacles=2;
     	break;
     case 7://test cases obstacle do not matter
     	numOfObstacles=2;
     	break;
     case 8://test cases obstacle do not matter
     	numOfObstacles=2;
     	break;
