...
/*
 * FDWSelection.java
 * This is a modification of the original IterationHW.java, which was
 * Created on March 1, 2002, 10:46 PM (package eecs.instructor.gossett)
 */
...
/**
 * The FDW Selection HW, Jul 2002.
 * 
 * <P>
 * All of the try clauses are a hack, due to the organization of the
 * packages and what is available--didn't account properly for
 * removal of elements. Need to fix in version 6.2
 * </p>
 *
 * @author Karl Gossett
 */
public class FDWSelection extends jago.SimBox
{
    ...
    public FDWSelection()
    {
        ...
        walls[2] = new Wall(5, 15);
        walls[3] = new Wall(5, 275);
        walls[4] = new Wall(5, 118);
        walls[5] = new Wall(5, 50);
        walls[6] = new Wall(138, 5);
        walls[7] = new Wall(5, 335);
        walls[8] = new Wall(5, 460);
        walls[9] = new Wall(100, 5);
        walls[10] = new Wall(100, 5);
        walls[11] = new Wall(100, 5);
        ...
        for (int i = 0; i < mainButton.length; i++)
        {
            ...
            add(mainButton[i], buttonLocations[i][0],
                buttonLocations[i][1]);
