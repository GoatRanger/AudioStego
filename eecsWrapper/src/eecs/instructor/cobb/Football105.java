...
class Football105 {
    ...
    public static FootballTeam105 Home=null;
    public static FootballTeam105 Visitor=null;
...
*/
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            if (names[i] != null) {
                ...
                try {
                    ...
                    if (i!=1){
                        Visitor= (FootballTeam105)teamClass.newInstance();
                    }
                    else
                    {    
                        Home = (FootballTeam105)teamClass.newInstance();
                    }   
    ...
    public static FootballTeam105 getHomeTeam()
	{
    	return Home;
    }
    public static FootballTeam105 getVisitingTeam()
	{
    	return Visitor;
    }
    /**
