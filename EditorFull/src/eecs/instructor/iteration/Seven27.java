 ...
 */
public class Seven27 extends eecs.RobotGuiBase {
  private static final int MAX_DOWN_CARDS = 250;

  static {
    sim = new eecs.robot.jago.SimBox();
    sim.setSimTitle("7-27");

    Image bg = ImageLoader.getImage(new Seven27(), "/eecs/images/cards/7-27.GIF");
  ...
  private static void initDisplay2(PlayerObj player) {
    player.getCurCardPositionX();
    player.getCurCardPositionY();
