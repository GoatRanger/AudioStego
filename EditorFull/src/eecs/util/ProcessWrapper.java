...
//        logger.info("Running--WorkingDir: " + workDir);
//        
//      }
    ...
    if (process != null) {
      ...
      outThread = new ReaderThread(process.getInputStream(),"inputstream");
      errThread = new ReaderThread(process.getErrorStream(),"errorstream");
  ...
  private class ReaderThread extends Thread {
    ...
    public ReaderThread(InputStream inStream, String name) {
      super("Stream_reader "+ name);
