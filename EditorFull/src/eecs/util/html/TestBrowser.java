 ...
 */
/*
 * TestBrowser.java A test bed for the JEditorPane and a custom editor kit. This extremely simple browser has a text field for typing in new
 * urls, a JEditorPane to display the HTML page, and a status bar to display the contents of hyperlinks the mouse passes over.
 */
