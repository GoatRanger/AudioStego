 ...
 * @version CVS $Id: ExecRunner.java,v 1.25 2002/09/15 01:28:45 smccrory Exp $
 */
public class ExecRunner {
  ...
  private static final String VERSION = "CVS $Revision: 1.25 $";
   ...
   * ExecRunner's out and err strings, where you then use getOutString() and
   * getErrString() to obtain these values. Example:
   * 
   * <pre>
   * 
