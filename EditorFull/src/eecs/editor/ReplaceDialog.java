...
public class ReplaceDialog extends javax.swing.JDialog {
  ...
  public ReplaceDialog(java.awt.Frame parent, boolean modal, ActionListener listener) {
    super(parent, modal);
    initComponents();
  ...
  private void initComponents() { //GEN-BEGIN:initComponents
    ...
    findLabel.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(4, 4, 4, 4)));
    ...
    replaceLabel.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(4, 4, 4, 4)));
    gridBagConstraints = new java.awt.GridBagConstraints();
