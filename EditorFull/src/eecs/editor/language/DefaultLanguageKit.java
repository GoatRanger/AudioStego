 ...
 */
/*
 * Created on Aug 21, 2003 To change the template for this generated file go to Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and
 * Comments
 */
...
class DefaultLanguageKit implements LanguageKit {
  ...
  /**
   * Reports if this language can be executed. The default language is not runnable; other languages must override this method if they can
   * be executed.
   * 
