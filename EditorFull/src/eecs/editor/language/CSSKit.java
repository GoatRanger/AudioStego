 ...
 */
/*
 * Created on Aug 27, 2003 To change the template for this generated file go to Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and
 * Comments
 */
...
class CSSKit extends DefaultLanguageKit {
  ...
  /**
   * Returns the percentage of error checking that is complete. Since the current checker does not report partial status, always returns
   * 100.
   * 
  ...
  public void compile(File file) {
    ...
    compileResult = (checker.getValid()) ? LanguageKit.COMPILE_SUCCESS : LanguageKit.COMPILE_FAILURE;
