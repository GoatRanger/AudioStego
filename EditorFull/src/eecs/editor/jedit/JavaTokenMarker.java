/*
 * JavaTokenMarker.java - Java token marker Copyright (C) 1999 Slava Pestov You may use and modify this package for any purpose.
 ...
 * 
 * @author Slava Pestov
 * @version $Id: JavaTokenMarker.java,v 1.1 2005/01/07 16:17:16 dj2087 Exp $
 */
public class JavaTokenMarker extends CTokenMarker {
  ...
  public static KeywordMap getKeywords() {
    if (javaKeywords == null) {
      ...
      // The following are added to eecs.editor.help IT105 students identify commonly used names
      javaKeywords.add("String", Token.KEYWORD3);
      javaKeywords.add("Math", Token.KEYWORD3);
    }
    return javaKeywords;
  }
  // private members
