/*
 * DefaultInputHandler.java - Default implementation of an input handler Copyright (C) 1999 Slava Pestov You may use and modify this package
 ...
 * 
 * @author Slava Pestov
 * @version $Id: DefaultInputHandler.java,v 1.1 2005/01/07 16:17:15 dj2087 Exp $
 */
public class DefaultInputHandler extends InputHandler {
  ...
  /**
   * Adds a key binding to this input handler. The key binding is a list of white space separated key strokes of the form <i>[modifiers+]key
   * </i> where modifier is C for Control, A for Alt, or S for Shift, and key is either a character (a-z) or a field name in the KeyEvent
   * class prefixed with VK_ (e.g., BACK_SPACE)
   * 
   * @param keyBinding
   *          The key binding
   * @param action
  ...
  public void keyPressed(KeyEvent evt) {
    ...
    if ((modifiers & ~InputEvent.SHIFT_MASK) != 0 || evt.isActionKey() || keyCode == KeyEvent.VK_BACK_SPACE
        || keyCode == KeyEvent.VK_DELETE || keyCode == KeyEvent.VK_ENTER || keyCode == KeyEvent.VK_TAB || keyCode == KeyEvent.VK_ESCAPE) {
      if (grabAction != null) {
