/*
 * TextAreaDefaults.java - Encapsulates default values for various settings Copyright (C) 1999 Slava Pestov You may use and modify this
...
public class TextAreaDefaults {
  ...
  public int cols;
  /** The minimum number of rows that must be displayed */
  public int rows;
