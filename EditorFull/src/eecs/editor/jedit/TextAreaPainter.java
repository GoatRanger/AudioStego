/*
 * TextAreaPainter.java - Paints the text area Copyright (C) 1999 Slava Pestov You may use and modify this package for any purpose.
 ...
 * 
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.2 2005/01/18 17:29:43 dj2087 Exp $
 */
public class TextAreaPainter extends JComponent implements TabExpander {
  ...
  /**
   * Enables or disables bracket highlighting. When bracket highlighting is enabled, the bracket matching the one before the caret (if any)
   * is highlighted.
   * 
  ...
  public interface Highlight {
    ...
    /**
     * Returns the tool tip to display at the specified location. If this highlighter doesn't know what to display, it should delegate to
     * the next highlight painter.
     * 
     * @param evt
     *          The mouse event
     */
  ...
  protected void paintHighlight(Graphics gfx, int line, int y) {
    ...
    // Hack to fix exception when checking brackets in HTML jwj 18Jan05
    JTabbedPane programTabs = (JTabbedPane) LookUpTable.getInstance().get("programTabs");
    EditPanel panel = (EditPanel) programTabs.getSelectedComponent();
    LanguageKit languageKit = panel.getLanguageKit();
    if (languageKit.getLanguage().equals(LanguageKit.JAVA)) {
