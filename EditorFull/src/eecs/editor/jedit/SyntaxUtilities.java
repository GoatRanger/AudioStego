/*
 * SyntaxUtilities.java - Utility functions used by syntax colorizing Copyright (C) 1999 Slava Pestov You may use and modify this package
 * for any purpose. Redistribution is permitted, in both source and binary form, provided that this notice remains intact in all source
 ...
 * 
 * @author Slava Pestov
 * @version $Id: SyntaxUtilities.java,v 1.1 2005/01/07 16:17:15 dj2087 Exp $
 */
public class SyntaxUtilities {
  ...
  /**
   * Returns the default style table. This can be passed to the <code>setStyles()</code> method of <code>SyntaxDocument</code> to use
   * the default syntax styles.
   */
  public static SyntaxStyle[] getDefaultSyntaxStyles() {
    SyntaxStyle[] styles = new SyntaxStyle[Token.ID_COUNT];
    //    styles[Token.COMMENT1] = new SyntaxStyle(Color.GREEN.darker(),false,false);
    styles[Token.COMMENT1] = new SyntaxStyle(new Color(0x006600), false, false);
    styles[Token.COMMENT2] = new SyntaxStyle(new Color(0x006600), false, false);
    //    styles[Token.COMMENT2] = new SyntaxStyle(new Color(0x006600),false,false);
    ...
    styles[Token.KEYWORD3] = new SyntaxStyle(new Color(0x000096), false, false);
    styles[Token.LITERAL1] = new SyntaxStyle(new Color(0x993333), false, false);
    styles[Token.LITERAL2] = new SyntaxStyle(new Color(0x336666), false, true);
    styles[Token.LABEL] = new SyntaxStyle(new Color(0x990033), false, true);
    styles[Token.OPERATOR] = new SyntaxStyle(Color.darkGray, false, true);
