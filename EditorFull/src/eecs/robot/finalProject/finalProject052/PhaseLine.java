...
public class PhaseLine extends VisibleElement implements Collidable, FlatObject {
  int width;
  Color color;
  GeneralPath path;
  boolean fillPath;
  ...
  public PhaseLine(GeneralPath path, Color color, boolean fillPath, int width) {
    super();
    this.width = width;
    this.path = path;
    this.color = color;
