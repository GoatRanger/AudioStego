...
public class ObstacleSim extends SimBox {
  ...
  public void createObstacles() {
    ...
    // 	obstacles (num 1)
    /*
     * leftObstacle1=new Wall(200,50); add(leftObstacle1, 70,425); add(circle[0],270+25,425+25); rightObstacle1=new Wall(130,50);
    ...
    for (int i = 0; i <= 1; i++) {
      ...
      /*
       * if (randomObstacleType[i+1]==3){ obstacleArray[i].setLeftObstacle(new Wall(byPassXLocation[i],10));
       * obstacleArray[i].setRightObstacle(new Wall(xEnd-rightObstacleBegin,10)); fillColor=Color.GREEN; }
       */
    ...
    if (System.getProperty("eecs.robot.wrapper.testing", "false").equals("true")) {
      ...
      System.err.println("Direction of Bridge: " + leftOrRight);
