...
public class Wall
    ...
    public static final String HORZ_HALF_IMG = "/eecs/images/horz_half_piece.gif";
    public static final int HORZ_HALF_LENGTH = 250;
    public static final int HORZ_LONG = 1;
    public static final String HORZ_LONG_IMG = "/eecs/images/horz_long_piece.gif";
    ...
    public static final String HORZ_QUARTER_IMG =
            "/eecs/images/horz_quarter_piece.gif";
    ...
    public static final String HORZ_THREE_QUARTER_IMG =
            "/eecs/images/horz_threeQuarter_piece.gif";
    ...
    public static final String VERT_LONG_IMG = "/eecs/images/vert_long_piece.gif";
    ...
    public Wall(int width, int height) {
        ...
        setTexture("/eecs/images/DefaultWall.gif");
    }
