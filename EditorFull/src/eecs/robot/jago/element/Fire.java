 ...
 */
public class Fire extends SolidElement {
   ...
   * 
   * @param imgFile
   *          The name of the image that represents this Fire.
   */
   ...
   * 
   * @param width
   *          The width of the fire (in pixels).
   * @param height
   *          The height of the fire (in pixels).
   */
  public Fire(int width, int height) {
    ...
    setTexture("/eecs/images/fire1.gif");
  }
