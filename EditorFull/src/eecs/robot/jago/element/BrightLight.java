...
public class BrightLight extends VisibleElement implements LightSource {
   ...
   * 
   * @param intensity
   *          The intensity of the light, between 0 and <CODE>MAX_INTENSITY</CODE>
   */
  ...
  /**
   * Sets the intesity of this BrightLight. If an out-of-range intensity is requested, the default intensity is set
   * (100).
   * 
   * @param intensity
   *          The desired intensity of this BrightLight
   */
  ...
  public void draw(java.awt.Graphics2D g2) {
    ...
    java.awt.Color c = new java.awt.Color(250, 250, 210, intensity * 2);
  ...
  protected void createArea() {
    myShape = new java.awt.geom.Area(new java.awt.geom.Ellipse2D.Double(location.getX() - (size.getWidth() / 2),
        location.getY() - (size.getHeight() / 2), size.getWidth(), size.getHeight()));
  }
}