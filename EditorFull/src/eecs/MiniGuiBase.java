 ...
 * @version %I%, %G%
 */
public class MiniGuiBase extends JApplet {
   ...
   * 
   * @param prompt
   *          A <code>String</code> prompt for the window.
   * @param items
   *          An array of <code>String</code> s to use as the items of the list.
  ...
  /**
   * Uses the FreeTTS text-to-speech package to speak. Speaking characters can be difficult as the time to initialize the engine and the
   * style of utterance may result in unintelligible speech.
   * 
   * @param ch
  ...
  /**
   * Gets any properties that might affect how the simulation/wrapper is run. <br />
   * <p>
