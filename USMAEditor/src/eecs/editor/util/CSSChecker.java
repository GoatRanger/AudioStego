...
public class CSSChecker implements org.w3c.css.sac.DocumentHandler {
  ...
  public CSSChecker() {
    ...
    try {
      ...
      System.err.println(
        "org.w3c.css.properties3.Css3Properties: couldn't load properties ");
  ...
  public String check(final java.io.File file) {
    ...
    try {
      ...
      if ((errorList != null) && (warningList != null) &&
        ...
        buffer.append(
          "<br><em>Sorry, I was distracted and forgot what line I was on." +
      ...
      for (int count = 0; count < errorList.length; count++) {
    	...
    	if (e instanceof CssParseException) {
    		...
    		if (msg != null && msg.equalsIgnoreCase("unknown dimension")) msg = "Invalid Value";
    		...
    		if (cssError.getContexts() != null) {
	    		...
	    		while (contexts.hasNext()) {
	    			...
	    			if (contexts.hasNext()) contextList += " ";
	    		}
    		}
          ...
          buffer.append("<em><font color=\"red\">Error: " + 
            errorList[count].getException().getMessage() + "</font></em><br>");
    	}
    }

      for (int count = 0; count < warningList.length; count++) {
        buffer.append("<em><font color=\"#A0522D\">Warning: " +
          warningList[count].getWarningMessage() + "</font></em><br>");
      }
    ...
    if (isValid) {
      ...
      buffer.append(
        "<p><font color=\"red\">Note: Web page presentation relies on both the XHTML and CSS, so " +
...
//     System.out.println("   " + name + ": " + val + (important?"!":"") + ";");
  ...
  class CSSErrorHandler implements org.w3c.css.sac.ErrorHandler {
    public void warning(CSSParseException cpe) {
      ...
      buffer.append("<b><font color=\"#A0522D\">Warning: Line: " + line + ": " +
        getHTMLString(warning) + "</font></b><br>");
    }
    ...
    public void fatalError(CSSParseException cpe) {
      ...
      String warning = cpe.getMessage();
      buffer.append("<b><font color=\"red\">Error: Line: " + line + ": " +
        getHTMLString(warning) + "<b><font color=\"red\">");
      isValid = false;
    }
