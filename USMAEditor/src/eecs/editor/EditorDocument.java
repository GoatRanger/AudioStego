...
public class EditorDocument extends SyntaxDocument {
	...
	/**
	 * Ends a compound edit that can be undone in one operation. Throws a
	 * NullPointerException if this method is called and there are no compound
	 * edits to end.
	 */
	...
	/**
	 * Fires when an undoable edit happens. Passes control to
	 * {@link #addUndoableEdit}to determine if the edit should be added to a
	 * compound edit, passed along to the UndoableEditListeners, or just ignored
	 * (if not significant).
	 * 
