...
class DefaultLanguageKit implements LanguageKit {
	...
	/**
	 * Reports if this language can be executed. The default language is not
	 * runnable; other languages must override this method if they can be
	 * executed.
	 * 
	...
	/**
	 * Returns the percent of error checking completed. Default is to always
	 * reply with 100.
	 * 
