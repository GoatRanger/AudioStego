...
public class MRUManager {
  ...
  /** Adds a new file to the MRUManager.  If the addition would exceed
   * the capacity of the list, the last item is lost.
   *
   * @param filename  The full path to the file to add
   */
