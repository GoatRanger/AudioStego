 ...
 * PropertyDialog.java
 *
 * Created on May 7, 2003, 10:12 PM
 */
package eecs.editor;
...
public class PropertyDialog extends javax.swing.JDialog {
  ...
  public PropertyDialog(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    //tabSizeEntry.addActionListener(this);
  }
 ...
 */
  private void initComponents() {
    ...
    indentationPanel.setBorder(new javax.swing.border.TitledBorder(null,
        "Indentation", javax.swing.border.TitledBorder.LEFT,
        javax.swing.border.TitledBorder.DEFAULT_POSITION));
    indentationPanel.setToolTipText(
      "Converts tabs to the specified number of spaces");
    ...
    tabSizeEntry.setModel(new javax.swing.DefaultComboBoxModel(
        new String[] { "2", "3", "4", "6", "8", "10" }));
    tabSizeEntry.setToolTipText(
    ...
    autoSaveList.setModel(new javax.swing.DefaultComboBoxModel(
        new String[] { "1", "2", "5", "10", "15", "30" }));
  ...
  private void acceptAction(java.awt.event.ActionEvent evt) {
  ...
  private void textScrollChanged(javax.swing.event.ChangeEvent evt) {
    textSizeSample.setFont(new Font("Monospaced", Font.PLAIN,
        textSlider.getValue()));
  }
 ...
 */
  public static void main(String[] args) {
    new PropertyDialog(new javax.swing.JFrame(), true).setVisible(true);
  }
}
