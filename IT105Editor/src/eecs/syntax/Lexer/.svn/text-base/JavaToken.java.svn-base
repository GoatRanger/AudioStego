...
public class JavaToken extends Token {
  ...
  /**
   * An identifier for the String class, to help reduce overriding
   */
  public final static int CLASS_LANG_STRING = 0x600;

  /**
   * An identifier for the String class, to help reduce overriding
   */
  public final static int CLASS_LANG_MATH = 0x601;
   ...
   */
  public JavaToken(int ID, String contents, int lineNumber, int charBegin,
    int charEnd) {
  ...
  *
  ...
  public String toString() {
    ...
    " Line " + lineNumber + " from " + charBegin + " to " + charEnd + " : " +
    contents);
  }
}
