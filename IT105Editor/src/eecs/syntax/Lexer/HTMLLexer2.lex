...
/** 
 * HTMLLexer2 is a html 2.0 lexer.  Created with JFlex.  An example of how it is used:
 *  <CODE>
 *  <PRE>
...
%{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HTMLLexer2 shredder = new HTMLLexer2(in);
            Token t;
            while ((t = shredder.getNextToken()) != null) {
...
<TAG, START_EQUAL, COMMENT_DEF, DOCTYPE, FINISH_END_TAG> {TagEnd}|{SelfClosingTagEnd} {
    nextState = YYINITIAL;
