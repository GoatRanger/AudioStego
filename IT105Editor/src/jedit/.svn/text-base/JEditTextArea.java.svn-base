 ...
 * 
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.2 2004/05/31 17:02:11 dk8685 Exp $
 */
public class JEditTextArea extends JComponent {
  ...
  public JEditTextArea(TextAreaDefaults defaults) {
    ...
    /* Can't use the defaults document because it will
     * conflict when using multiple tabs in the editor
     */
    /* TODO: Make sure there are no conflicts using
     * defaults in the multiple tab context.
     */
...
//    }
  ...
  class LineNumber extends JComponent {
    ...
    private void updatePreferredSize(int row) {
