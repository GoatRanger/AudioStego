 ...
 * PolarPoint.java
 *
 * Created on July 29, 2002, 1:44 PM
 */

package jago.element;

/**
 *  A polar coordinate pair (magnitude, direction), where the 0 degree heading
 * relates to a vertical vector (x component=0).  Since this is different from
 * a standard mathematical polar coordinate system, users of this class should
 * take care to implement the correct math based on this transformation.
...
public class PolarPoint {
    ...
    public boolean equals(Object obj) {
        ...
        if (direction == pt.getDirection() && magnitude == pt.getMagnitude()) {
            return true;
        } else {
            return false;
        }
    ...
    /** Returns the y component of the vector, with a coordinate system where
     * the y axis is inverted (positive down).
     */
    public double getY() {
