...
public class MovingDoor
     ...
     */
    public MovingDoor() {
        closedDoor = jago.ImageLoader.getImage(this, "images/door_vert.gif");
        openDoor = jago.ImageLoader.getImage(this, "images/door_right.gif");
        partialOpenDoor = jago.ImageLoader.getImage(this, "images/door_right45.gif");
