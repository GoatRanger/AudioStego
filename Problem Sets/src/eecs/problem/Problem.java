...
public class Problem {
  ...
  private void getTestCases(final Document document) {
    ...
    testInputs = new Vector<String>(numSections);
    testCaseDescription = new Vector<String>(numSections);
    testCaseOutputType = new Vector<String>(numSections);
    testOutputs = new Vector<String>(numSections);
  ...
  private String runTest(final String command, final File dir,
    ...
    /** Could use this to calculate total time to run the tests, might be useful to provide feedback on optimization? **/
    ...
    /** And get finish time here, if useful **/
