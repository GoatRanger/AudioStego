...
/**
 * An implementation of concertina wire.
 */
public class Concertina
    extends SolidElement {

    /**
     * Creates a new Concertina object.
     * 
     * @param imgFile The name of the image that represents this Concertina.
     */
    ...
    /**
     * Creates a new <CODE>Concertina obstacle</CODE> with the specified dimensions.  Walls
    ...
    public Concertina(int width, int height) {
    	...
    	setTexture("images/Concertina_horizontal.GIF");
    }
